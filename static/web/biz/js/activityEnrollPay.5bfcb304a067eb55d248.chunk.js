...
/***/ (function(module, exports, __webpack_require__) {
	...
	Pay=function(_React$Component){(0,_inherits3.default)(Pay,_React$Component);
	function Pay(props){(0,_classCallCheck3.default)(this,Pay);var _this=(0,_possibleConstructorReturn3.default)(this,(Pay.__proto__||(0,_getPrototypeOf2.default)(Pay)).call(this,
	props));
	_this.state={
	fee:0,
	startTime:"",
	...
	['changePayType'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(Pay,[{key:'componentWillMount',value:function componentWillMount()
	...
	{
	clearInterval(this.cycleResult);
	}},{key:'checkPayResult',value:function checkPayResult(
	
	orderNo){
	var that=this;
	this.cycleResult=setInterval(function(){
	ajax({
	url:"/pay/getOrderStatus",
	data:{orderNo:orderNo},
	callback:function callback(data){
	if(data.payStatus){
	clearInterval(that.cycleResult);
	if(data.payStatus==1){
	_antd.message.success("充值成功！",1,function(){
	_reactRouter.hashHistory.push("/project/space");
	});
	}else{
	_antd.message.error("充值失败，请重新扫码支付！");
	}
	}else{
	_antd.message.warn("请尽快扫码充值，如已完成支付请耐心等待系统处理~");
	}
	}});
	
	},5000);
	}},{key:'getQRCode',value:function getQRCode()
	...
	url:"/pay/createOrder",
	data:{
	money:that.state.number,
	payWay:this.state.type},
	
	callback:function callback(dataFirst){
	var orderNo=dataFirst;
	that.setState({
	payQRCode:'/pay/qrCodePay?orderNo='+orderNo});
	
	that.checkPayResult(orderNo);
	}});
	
	}},{key:'changePayType',value:function changePayType(
	...
	{
	var person=this.props.location.query.person;
	var cost=parseInt(this.state.fee,10)*parseInt(person,10);
	var wxStyle={
	display:'block',
	height:'50px',
	lineHeight:'50px'};
	...
	return(
	_react2.default.createElement(_antd.Row,{className:'activityPay'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u8D39\u7528\u652F\u4ED8'),
	_react2.default.createElement(_antd.Row,{className:'frame',type:'flex',justify:'center',align:'middle'},
	_react2.default.createElement(_antd.Col,{span:12,className:'payInfo'},
	_react2.default.createElement(_antd.Row,{className:'fees'},
	_react2.default.createElement(_antd.Col,{span:4},'\u6D3B\u52A8\u8D39\u7528:'),
	_react2.default.createElement(_antd.Col,{span:8,className:'cost'},this.state.fee,'\u5143/\u4EBA\xA0*\xA0',person,'\u4EBA\xA0=\xA0',cost,'\u5143'),
	_react2.default.createElement(_antd.Col,{span:4},'\u5F00\u59CB\u65F6\u95F4:'),
	_react2.default.createElement(_antd.Col,{span:8},this.state.startTime)),
	
	_react2.default.createElement(_antd.Row,{className:'title'},
	_react2.default.createElement(_antd.Col,{span:4},'\u6D3B\u52A8\u540D\u79F0:'),
	_react2.default.createElement(_antd.Col,{span:20},this.state.title)),
	
	_react2.default.createElement(_antd.Row,{className:'type'},
	_react2.default.createElement(_antd.Col,{span:4},'\u4ED8\u6B3E\u65B9\u5F0F:'),
	_react2.default.createElement(_antd.Col,{span:18},
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Col,{span:6,className:'iconWx'}),
	_react2.default.createElement(_antd.Col,{span:16,offset:2},
	_react2.default.createElement(_antd.Row,{className:'payTitle'},'\u5FAE\u4FE1\u652F\u4ED8'),
	_react2.default.createElement(_antd.Row,{className:'payPrompt'},'\u63A8\u8350\u5DF2\u5B89\u88C5\u5FAE\u4FE1\u94B1\u5305\u7684\u7528\u6237\u4F7F\u7528'))),
	
	
	_react2.default.createElement(_antd.Row,{style:{marginTop:25}},
	_react2.default.createElement(_antd.Col,{span:6,className:'iconAlipay'}),
	_react2.default.createElement(_antd.Col,{span:16,offset:2},
	_react2.default.createElement(_antd.Row,{className:'payTitle'},'\u652F\u4ED8\u5B9D'),
	_react2.default.createElement(_antd.Row,{className:'payPrompt'},'\u63A8\u8350\u5DF2\u5B89\u88C5\u652F\u4ED8\u5B9D\u7684\u7528\u6237\u4F7F\u7528')))),
	
	
	
	_react2.default.createElement(_antd.Col,{span:2},
	_react2.default.createElement(RadioGroup,{onChange:this.changePayType,defaultValue:this.state.type},
	_react2.default.createElement(_antd.Radio,{style:wxStyle,value:2}),
	_react2.default.createElement(_antd.Radio,{style:alipayStyle,value:3})))),
	
	
	
	_react2.default.createElement(_antd.Row,{type:'flex',justify:'center'},
	_react2.default.createElement(_antd.Col,{span:12,style:{textAlign:'center'}},
	_react2.default.createElement('img',{className:'qrCode',src:this.state.payQRCode}),
	_react2.default.createElement(_antd.Row,null,'[\u626B\u7801\u652F\u4ED8]')))))));
	...
	}}]);return Pay;}(_react2.default.Component);
...
//# sourceMappingURL=activityEnrollPay.5bfcb304a067eb55d248.chunk.js.map