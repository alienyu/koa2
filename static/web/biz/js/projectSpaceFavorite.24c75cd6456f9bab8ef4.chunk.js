...
/***/ (function(module, exports, __webpack_require__) {
	...
	['changePage','goToFundDetail','deleteFavorite'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	...
	var that=this;
	ajax({
	url:"/project/favorite/getInfoList",
	data:{page:page},
	callback:function callback(data){
	that.setState({
	...
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u6211\u6536\u85CF\u7684\u8D44\u91D1'),
	...
	_react2.default.createElement(_antd.Row,{onClick:_this2.goToFundDetail.bind(_this2,item.id,item.feature)},
...
//# sourceMappingURL=projectSpaceFavorite.24c75cd6456f9bab8ef4.chunk.js.map