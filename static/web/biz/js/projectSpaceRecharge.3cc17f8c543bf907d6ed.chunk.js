...
/***/ (function(module, exports, __webpack_require__) {
	...
	Recharge=function(_React$Component){(0,_inherits3.default)(Recharge,_React$Component);
	function Recharge(props){(0,_classCallCheck3.default)(this,Recharge);var _this=(0,_possibleConstructorReturn3.default)(this,(Recharge.__proto__||(0,_getPrototypeOf2.default)(Recharge)).call(this,
	props));
	_this.state={
	payQRCode:"",
	number:0,
	...
	['changePayType','changeNum'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(Recharge,[{key:'componentWillUnmount',value:function componentWillUnmount()
	...
	var that=this;
	clearInterval(this.cycleResult);
	if(that.state.number&&that.state.number.match(/(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/)){
	ajax({
	url:"/pay/createOrder",
	data:{
	...
	_antd.message.error("请输入正确得金额！");
	}
	}},{key:'changePayType',value:function changePayType(
	
	e){
	this.state.type=e.target.value;
	}},{key:'changeNum',value:function changeNum(
	...
	return(
	_react2.default.createElement(_antd.Row,{className:'rechargeFrame'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u8D26\u6237\u5145\u503C'),
	...
	_react2.default.createElement(_antd.Row,{className:'numberFrame'},
	_react2.default.createElement(_antd.Col,{span:4},'\u5145\u503C\u91D1\u989D:'),
	_react2.default.createElement(_antd.Col,{span:18},
	_react2.default.createElement(_antd.Input,{type:'number',onChange:this.changeNum,placeholder:'\u8BF7\u8F93\u5165\u5145\u503C\u91D1\u989D'}))),
	
	
	_react2.default.createElement(_antd.Row,{className:'type'},
	_react2.default.createElement(_antd.Col,{span:4},'\u5145\u503C\u65B9\u5F0F:'),
	_react2.default.createElement(_antd.Col,{span:18},
	...
	_react2.default.createElement(_antd.Row,{type:'flex',justify:'center',style:{marginBottom:20}},
	_react2.default.createElement(_antd.Col,{span:6},
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:this.getQRCode.bind(this)},'\u751F\u6210\u652F\u4ED8\u7801'))),
	...
	}}]);return Recharge;}(_react2.default.Component);
...
//# sourceMappingURL=projectSpaceRecharge.3cc17f8c543bf907d6ed.chunk.js.map