...
/***/ (function(module, exports, __webpack_require__) {
	...
	var that=this;
	ajax({
	url:"/about/getNewsList",
	data:{page:page},
	callback:function callback(data){
	that.setState({
	newsList:data.infoList,
	total:data.total});
	...
	{
	return(
	_react2.default.createElement(_antd.Row,{className:'newsListFrame'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u884C\u4E1A\u52A8\u6001'),
	_react2.default.createElement(_antd.Row,{className:'list'},
	this.state.newsList.map(function(item){return(
	...
	_react2.default.createElement(_antd.Col,{span:20,className:'title'},_react2.default.createElement(_reactRouter.Link,{to:'/about/news/'+item.id},item.title)),
...
//# sourceMappingURL=newsList.1ce30205dbe4ac45c00a.chunk.js.map