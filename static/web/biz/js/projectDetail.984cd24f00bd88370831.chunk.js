...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _normalInfo=__webpack_require__(1577);var _normalInfo2=_interopRequireDefault(_normalInfo);
	var _delegateInfo=__webpack_require__(1579);var _delegateInfo2=_interopRequireDefault(_delegateInfo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
	
	Detail=function(_React$Component){(0,_inherits3.default)(Detail,_React$Component);
	function Detail(props){(0,_classCallCheck3.default)(this,Detail);return(0,_possibleConstructorReturn3.default)(this,(Detail.__proto__||(0,_getPrototypeOf2.default)(Detail)).call(this,
	props));
	}(0,_createClass3.default)(Detail,[{key:'render',value:function render()
	
	{
	return(
	_react2.default.createElement(_antd.Row,{className:'projectDetailFrame'},
	...
	this.props.location.query.type=='normal'?_react2.default.createElement(_normalInfo2.default,{id:this.props.params.id,type:this.props.location.query.type}):_react2.default.createElement(_delegateInfo2.default,{id:this.props.params.id,type:this.props.location.query.type})));
	
	
	}}]);return Detail;}(_react2.default.Component);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactRouter=__webpack_require__(232);
	var _antd=__webpack_require__(391);
	var _reportForm=__webpack_require__(1578);var _reportForm2=_interopRequireDefault(_reportForm);
	var _mobxReact=__webpack_require__(1419);
	var _userStore=__webpack_require__(1421);var _userStore2=_interopRequireDefault(_userStore);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
	
	
	NormalInfo=(0,_mobxReact.observer)(_class=function(_React$Component){(0,_inherits3.default)(NormalInfo,_React$Component);
	function NormalInfo(props){(0,_classCallCheck3.default)(this,NormalInfo);var _this=(0,_possibleConstructorReturn3.default)(this,(NormalInfo.__proto__||(0,_getPrototypeOf2.default)(NormalInfo)).call(this,
	props));
	_this.state={
	authOps:_userStore2.default.userInfo.type&&_userStore2.default.userInfo.type=="fund"?true:false,
	payModal:false,
	noLeftModal:false,
	reportModal:false,
	projectInfo:{
	...
	['checkDetail','setFavorite','report','showPayModal','hidePayModal','showNoLeftModal','hideNoLeftModal','handlePay','goToRecharge','hideReportModal','handleReportSuccess'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(NormalInfo,[{key:'handlePay',value:function handlePay()
	
	{
	var that=this;
	ajax({
	url:"/project/getDetailContactInfo",
	data:{id:that.props.id},
	callback:function callback(data){
	if(data.canSeen){
	_antd.message.success("获取联系方式成功",1,function(){
	that.state.projectInfo.hasSeen=true;
	that.state.projectInfo.seenNum++;
	that.setState({
	projectInfo:that.state.projectInfo,
	...
	that.hidePayModal();
	that.showNoLeftModal();
	}
	}});
	
	}},{key:'handleReportSuccess',value:function handleReportSuccess()
	
	{
	this.hideReportModal();
	this.state.projectInfo.hasReport=true;
	this.state.projectInfo.reportNum++;
	this.setState({
	projectInfo:this.state.projectInfo});
	
	}},{key:'showPayModal',value:function showPayModal()
	
	{
	this.setState({payModal:true});
	}},{key:'hidePayModal',value:function hidePayModal()
	
	{
	this.setState({payModal:false});
	}},{key:'showNoLeftModal',value:function showNoLeftModal()
	
	{
	this.setState({noLeftModal:true});
	}},{key:'hideNoLeftModal',value:function hideNoLeftModal()
	
	{
	this.setState({noLeftModal:false});
	}},{key:'goToRecharge',value:function goToRecharge()
	
	{
	_reactRouter.hashHistory.push("/project/space/recharge");
	}},{key:'checkDetail',value:function checkDetail()
	
	{
	var that=this;
	this.showPayModal();
	}},{key:'setFavorite',value:function setFavorite()
	
	{
	var that=this;
	ajax({
	url:"/project/setFavorite",
	data:{
	id:that.props.id,
	type:that.props.type},
	
	callback:function callback(data){
	_antd.message.success("收藏成功",1,function(){
	that.state.projectInfo.hasFavorite=true;
	that.state.projectInfo.favoriteNum++;
	that.setState({
	projectInfo:that.state.projectInfo});
	...
	}},{key:'hideReportModal',value:function hideReportModal()
	...
	var that=this;
	ajax({
	url:"/project/getNormalInfoDetail",
	data:{
	id:that.props.id,
	type:that.props.type},
	...
	if(data.contactInfo&&data.projectInfo.hasSeen){
	that.setState({
	contactInfo:data.contactInfo});
	...
	_react2.default.createElement(_antd.Row,{className:'projectDetailInfoFrame'},
	_react2.default.createElement(_antd.Row,{className:'infoTitle'},
	_react2.default.createElement(_antd.Col,{span:9,offset:15,className:'status'},
	_react2.default.createElement(_antd.Col,{span:8},'\u6536\u85CF\xA0(',this.state.projectInfo.favoriteNum,')'),
	_react2.default.createElement(_antd.Col,{span:8},'\u67E5\u770B\u8054\u7CFB\u65B9\u5F0F\xA0(',this.state.projectInfo.seenNum,')'),
	_react2.default.createElement(_antd.Col,{span:8},'\u4E3E\u62A5\xA0(',this.state.projectInfo.reportNum,')'))),
	
	
	_react2.default.createElement(_antd.Row,{className:'infoContent'},
	_react2.default.createElement(_antd.Col,{span:15},
	_react2.default.createElement(_antd.Row,{className:'title'},this.state.projectInfo.title,_react2.default.createElement('i',{className:this.state.projectInfo.status==0?"over":"process"},this.state.projectInfo.status==0?"已结束":"进行中")),
	_react2.default.createElement(_antd.Row,{className:'content'},
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u9879\u76EE\u7C7B\u522B:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.categoryText)),
	
	this.state.projectInfo.categoryText=="债权"?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u9879\u76EE\u7C7B\u578B:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.typeText)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u878D\u8D44\u65B9\u540D\u79F0:'),
	_react2.default.createElement(_antd.Col,{span:18},'\u8BE6\u89C1\u6211\u8054\u7CFB\u65B9\u5F0F')),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u878D\u8D44\u65B9\u6240\u5C5E\u884C\u4E1A:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.financing.industryText)),
	
	this.state.projectInfo.financing.industryText=="房地产"?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u878D\u8D44\u65B9\u5F00\u53D1\u8D44\u8D28:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.financing.aptitude)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u6BCD\u516C\u53F8\u5F00\u53D1\u8D44\u8D28:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.financing.parentAptitue))):
	
	null,
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u878D\u8D44\u65B9\u6240\u5728\u5730:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.financing.regionText)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u878D\u8D44\u65B9\u53BB\u5E74\u51C0\u5229\u6DA6:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.financing.previousProfits,'\u4E07\u5143')),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u878D\u8D44\u91D1\u989D:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.financing.number,'\u4E07\u5143')),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u671F\u9650:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.financing.deadline,'\u5E74')),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u6700\u9AD8\u63A5\u53D7\u5229\u7387:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.financing.maxRate,'%')),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u6709\u65E0\u62B5/\u8D28\u62BC\u7269:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.mortgage.isNeed?"有":"无")),
	
	this.state.projectInfo.mortgage.isNeed?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u62B5/\u8D28\u62BC\u7269\u7C7B\u578B:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.mortgage.typeText)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u62B5/\u8D28\u62BC\u7269\u540D\u79F0:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.mortgage.name)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u62B5/\u8D28\u62BC\u7269\u4EF7\u503C:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.mortgage.value,'\u4E07\u5143')),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u62B5/\u8D28\u62BC\u7269\u6298\u6263\u7387:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.mortgage.rate,'%'))):
	
	null,
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u6709\u65E0\u62C5\u4FDD:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.guarantee.isNeed?"有":"无")),
	
	this.state.projectInfo.guarantee.isNeed?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u62C5\u4FDD\u65B9\u5F0F:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.guarantee.method))):
	
	null):
	
	null,
	
	this.state.projectInfo.categoryText=="股权"?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u53C2/\u63A7\u80A1:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.typeText)),
	...
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u80A1\u6743\u6027\u8D28:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.property)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},this.state.projectInfo.stockData.property=='新股增发'?'融资方名称':'转让方名称',':'),
	_react2.default.createElement(_antd.Col,{span:18},'\u8BE6\u89C1\u6211\u7684\u8054\u7CFB\u65B9\u5F0F')),
	
	this.state.projectInfo.stockData.property!='新股增发'?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u6807\u7684\u4F01\u4E1A\u540D\u79F0:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.target.name))):
	
	null,
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},this.state.projectInfo.stockData.property=='新股增发'?'融资方所属行业':'标的企业所属行业',':'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.property=='新股增发'?this.state.projectInfo.financing.industryText:this.state.projectInfo.target.industryText)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},this.state.projectInfo.stockData.property=='新股增发'?'融资方所在地':'标的企业所在地',':'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.property=='新股增发'?this.state.projectInfo.financing.regionText:this.state.projectInfo.target.regionText)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},this.state.projectInfo.stockData.property=='新股增发'?'融资方去年净利润':'标的企业去年净利润',':'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.property=='新股增发'?this.state.projectInfo.financing.previousProfits:this.state.projectInfo.target.previousProfits,'\u4E07\u5143')),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},this.state.projectInfo.stockData.property=='新股增发'?'融资金额':'转让金额',':'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.property=='新股增发'?this.state.projectInfo.financing.number:this.state.projectInfo.target.number,'\u4E07\u5143')),
	
	this.state.projectInfo.stockData.rate?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u51FA\u8BA9\u80A1\u6743\u6BD4\u4F8B:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.rate,'%'))):
	
	null,
	
	this.state.projectInfo.stockData.number?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u4F01\u4E1A\u6574\u4F53\u4F30\u503C:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.number,'\u4E07\u5143'))):
	
	null,
	
	this.state.projectInfo.stockData.estimateText?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u6295\u8D44\u4F30\u503C\u500D\u6570:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.estimateText))):
	
	null,
	
	this.state.projectInfo.financing.recentProfits||this.state.projectInfo.target.recentProfits?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u4F01\u4E1A\u4ECA\u5E74\u9884\u8BA1\u51C0\u5229\u6DA6:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.property=='新股增发'?this.state.projectInfo.financing.recentProfits:this.state.projectInfo.target.recentProfits,'\u4E07\u5143'))):
	
	null,
	
	this.state.projectInfo.financing.nextProfits||this.state.projectInfo.target.nextProfits?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u4F01\u4E1A\u660E\u5E74\u9884\u8BA1\u51C0\u5229\u6DA6:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.stockData.property=='新股增发'?this.state.projectInfo.financing.nextProfits:this.state.projectInfo.target.nextProfits,'\u4E07\u5143'))):
	
	null):
	
	null,
	
	this.state.projectInfo.categoryText=='资产转让'?
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u9879\u76EE\u7C7B\u578B:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.typeText)),
	...
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u8D44\u4EA7\u8F6C\u8BA9\u4EBA:'),
	_react2.default.createElement(_antd.Col,{span:18},'\u8BE6\u89C1\u6211\u8054\u7CFB\u65B9\u5F0F')),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u8D44\u4EA7\u6240\u5728\u5730:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.assets.regionText)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u8F6C\u8BA9\u91D1\u989D:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.assets.number)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u8D44\u4EA7\u4EF7\u503C:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.projectInfo.assets.value))):
	
	null,
	
	this.state.authOps?
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6,className:'label'},'\u9644\u4EF6:'),
	_react2.default.createElement(_antd.Col,{span:18},_react2.default.createElement('a',{href:this.state.projectInfo.attachment.link},this.state.projectInfo.attachment.name))):
	null)),
	
	
	
	_react2.default.createElement(_antd.Col,{span:9,className:'contactInfoFrame'},
	_react2.default.createElement(_antd.Col,{span:23,offset:1,className:'contactInfo'},
	_react2.default.createElement(_antd.Row,{className:'contactFrame'},
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u4F1A\u5458\u7C7B\u578B:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.memberType)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u540D\u79F0:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.companyName)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u90E8\u95E8:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.department)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u804C\u4F4Di:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.position)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u59D3\u540D:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.name)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u7535\u8BDD:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.phone)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u624B\u673A:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.mobile)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u90AE\u7BB1:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.email)))),
	
	
	
	this.state.authOps?
	_react2.default.createElement(_antd.Col,{span:23,offset:1,style:{marginTop:20}},
	_react2.default.createElement(_antd.Col,{span:7},
	_react2.default.createElement(_antd.Button,{onClick:this.checkDetail,type:'primary',disabled:this.state.projectInfo.hasSeen||!this.state.projectInfo.status?true:false,style:{width:'100%'}},'\u67E5\u770B\u8054\u7CFB\u65B9\u5F0F')),
	
	_react2.default.createElement(_antd.Col,{span:7,offset:1},
	_react2.default.createElement(_antd.Button,{onClick:this.setFavorite,disabled:this.state.projectInfo.hasFavorite||!this.state.projectInfo.status?true:false,style:{width:'100%'}},'\u6536\u85CF')),
	
	_react2.default.createElement(_antd.Col,{span:7,offset:1},
	_react2.default.createElement(_antd.Button,{type:'danger',onClick:this.report,disabled:this.state.projectInfo.hasReport||!this.state.projectInfo.status?true:false,style:{width:'100%'}},'\u4E3E\u62A5'))):
	...
	onOk:this.handlePay,
	onCancel:this.hidePayModal},
	
	_react2.default.createElement('p',null,'\u786E\u8BA4\u652F\u4ED820\u5143\u67E5\u770B\u8054\u7CFB\u65B9\u5F0F?')),
	
	_react2.default.createElement(_antd.Modal,{
	title:'\u4F59\u989D\u4E0D\u8DB3',
	closable:false,
	visible:this.state.noLeftModal,
	okText:'\u53BB\u5145\u503C',
	onOk:this.goToRecharge,
	onCancel:this.hideNoLeftModal},
	
	_react2.default.createElement('p',null,'\u4F59\u989D\u4E0D\u8DB3!\u65E0\u6CD5\u67E5\u770B\u8D44\u91D1\u65B9\u8054\u7CFB\u65B9\u5F0F,\u8BF7\u5145\u503C!')),
	...
	_react2.default.createElement(_reportForm2.default,{reportCallback:this.handleReportSuccess,hideReportModal:this.hideReportModal}))),
	
	
	_react2.default.createElement(_antd.Row,{className:'projectDetailContentFrame'},
	_react2.default.createElement(_antd.Row,{className:'title'},'\u9879\u76EE\u4ECB\u7ECD'),
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement('p',{className:'content'},this.state.projectInfo.content)))));
	
	
	
	
	}}]);return NormalInfo;}(_react2.default.Component))||_class;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RadioGroup=_antd.Radio.Group;var
	TextArea=_antd.Input.TextArea;var
	
	ReportForm=function(_React$Component){(0,_inherits3.default)(ReportForm,_React$Component);
	function ReportForm(props){(0,_classCallCheck3.default)(this,ReportForm);var _this=(0,_possibleConstructorReturn3.default)(this,(ReportForm.__proto__||(0,_getPrototypeOf2.default)(ReportForm)).call(this,
	props));
	_this.state={
	reportType:0};
	
	['checkContent','changeReportType','handleSubmit'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(ReportForm,[{key:'handleSubmit',value:function handleSubmit()
	...
	if(!err){
	ajax({
	url:"/project/submitReport",
	data:values,
	callback:function callback(data){
	_antd.message.success("举报成功!",1,function(){
	that.props.reportCallback();
	});
	}});
	
	}
	});
	}},{key:'changeReportType',value:function changeReportType(
	
	e){
	this.setState({reportType:e.target.value});
	}},{key:'checkContent',value:function checkContent(
	
	rule,value,callback){
	var form=this.props.form;
	if(form.getFieldValue('reportType')==3&&!value){
	callback("请输入举报内容!");
	}else{
	callback();
	}
	...
	_react2.default.createElement(RadioGroup,{onChange:this.changeReportType},
	_react2.default.createElement(_antd.Radio,{style:radioStyle,value:1},'\u53D1\u5E03\u4EBA\u8EAB\u4EFD\u865A\u5047'),
	_react2.default.createElement(_antd.Radio,{style:radioStyle,value:2},'\u4FE1\u606F\u865A\u5047\u6216\u4E3A\u4E8C\u624B'),
	_react2.default.createElement(_antd.Radio,{style:radioStyle,value:3},'\u5176\u4ED6')))),
	...
	_react2.default.createElement(TextArea,{rows:6,disabled:this.state.reportType!=3?true:false}))),
	
	
	_react2.default.createElement(_antd.Row,{type:'flex',justify:'center'},
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:this.handleSubmit,style:{width:'100%'}},'\u786E\u8BA4')),
	
	_react2.default.createElement(_antd.Col,{span:8,offset:1},
	_react2.default.createElement(_antd.Button,{type:'default',onClick:this.props.hideReportModal,style:{width:'100%'}},'\u53D6\u6D88')))));
	
	
	
	
	}}]);return ReportForm;}(_react2.default.Component);
	
	
	var WrappedReportForm=_antd.Form.create()(ReportForm);
	
	module.exports=WrappedReportForm;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1326)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactRouter=__webpack_require__(232);
	var _antd=__webpack_require__(391);
	var _delegateForm=__webpack_require__(1580);var _delegateForm2=_interopRequireDefault(_delegateForm);
	var _mobxReact=__webpack_require__(1419);
	var _userStore=__webpack_require__(1421);var _userStore2=_interopRequireDefault(_userStore);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
	
	
	DelegateInfo=(0,_mobxReact.observer)(_class=function(_React$Component){(0,_inherits3.default)(DelegateInfo,_React$Component);
	function DelegateInfo(props){(0,_classCallCheck3.default)(this,DelegateInfo);var _this=(0,_possibleConstructorReturn3.default)(this,(DelegateInfo.__proto__||(0,_getPrototypeOf2.default)(DelegateInfo)).call(this,
	props));
	_this.state={
	authOps:_userStore2.default.userInfo.type&&_userStore2.default.userInfo.type=="fund"?true:false,
	deliverModal:false,
	...
	['setFavorite','showDeliverModal','hideDeliverModal','handleDeliverSuccess'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(DelegateInfo,[{key:'handleDeliverSuccess',value:function handleDeliverSuccess()
	
	{
	this.hideDeliverModal();
	this.setState({
	projectInfo:this.state.projectInfo});
	
	}},{key:'showDeliverModal',value:function showDeliverModal()
	
	{
	this.setState({deliverModal:true});
	}},{key:'hideDeliverModal',value:function hideDeliverModal()
	...
	var that=this;
	ajax({
	url:"/project/getDelegateInfoDetail",
	data:{
	id:that.props.id,
	type:that.props.type},
	...
	_react2.default.createElement(_antd.Row,{className:'projectDetailInfoFrame'},
	_react2.default.createElement(_antd.Row,{className:'infoTitle'},
	_react2.default.createElement(_antd.Col,{span:5,style:{color:'#59A9FF',fontSize:14}},'\u5DF2\u59D4\u6258\u9633\u5149\u878D\u8D44'),
	_react2.default.createElement(_antd.Col,{span:9,offset:10,className:'status'},
	_react2.default.createElement(_antd.Col,{span:8,offset:16},'\u6536\u85CF\xA0(',this.state.projectInfo.favoriteNum,')'))),
	...
	_react2.default.createElement(_antd.Row,{className:'content'},
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:4,className:'label'},'\u9879\u76EE\u7C7B\u522B:'),
	_react2.default.createElement(_antd.Col,{span:20},this.state.projectInfo.category)),
	...
	_react2.default.createElement(_antd.Row,{className:'contactFrame'},
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u59D4\u6258\u4EBA:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.name)),
	
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u88AB\u59D4\u6258\u4EBA:'),
	_react2.default.createElement(_antd.Col,{span:18},'\u9633\u5149\u878D\u8D44')),
	...
	_react2.default.createElement(_antd.Row,{className:'line'},
	_react2.default.createElement(_antd.Col,{span:6},'\u804C\u4F4D:'),
	_react2.default.createElement(_antd.Col,{span:18},this.state.contactInfo.position)),
	...
	_react2.default.createElement(_antd.Col,{span:23,offset:1,style:{marginTop:20}},
	_react2.default.createElement(_antd.Col,{span:8,offset:2},
	_react2.default.createElement(_antd.Button,{onClick:this.showDeliverModal,type:'primary',disabled:!this.state.projectInfo.status?true:false,style:{width:'100%'}},'\u6295\u9012\u6211\u7684\u8D44\u91D1')),
	
	_react2.default.createElement(_antd.Col,{span:8,offset:4},
	_react2.default.createElement(_antd.Button,{type:'default',onClick:this.setFavorite,disabled:this.state.projectInfo.hasFavorite||!this.state.projectInfo.status?true:false,style:{width:'100%'}},'\u6536\u85CF'))))),
	
	
	
	
	this.state.deliverModal?
	_react2.default.createElement(_antd.Modal,{
	title:'\u6295\u9012\u5185\u5BB9',
	closable:false,
	visible:true,
	...
	_react2.default.createElement(_delegateForm2.default,{deliverCallback:this.handleDeliverSuccess,hideDeliverModal:this.hideDeliverModal})):
	null),
	...
	}}]);return DelegateInfo;}(_react2.default.Component))||_class;
	
	
	module.exports=DelegateInfo;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1326)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(ajax) {'use strict';var _extends2=__webpack_require__(299);var _extends3=_interopRequireDefault(_extends2);var _getPrototypeOf=__webpack_require__(339);var _getPrototypeOf2=_interopRequireDefault(_getPrototypeOf);var _classCallCheck2=__webpack_require__(344);var _classCallCheck3=_interopRequireDefault(_classCallCheck2);var _createClass2=__webpack_require__(345);var _createClass3=_interopRequireDefault(_createClass2);var _possibleConstructorReturn2=__webpack_require__(349);var _possibleConstructorReturn3=_interopRequireDefault(_possibleConstructorReturn2);var _inherits2=__webpack_require__(383);var _inherits3=_interopRequireDefault(_inherits2);var _react=__webpack_require__(55);var _react2=_interopRequireDefault(_react);
	var _reactRouter=__webpack_require__(232);
	var _antd=__webpack_require__(391);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
	var FormItem=_antd.Form.Item;var
	TextArea=_antd.Input.TextArea;var
	
	DelegateForm=function(_React$Component){(0,_inherits3.default)(DelegateForm,_React$Component);
	function DelegateForm(props){(0,_classCallCheck3.default)(this,DelegateForm);var _this=(0,_possibleConstructorReturn3.default)(this,(DelegateForm.__proto__||(0,_getPrototypeOf2.default)(DelegateForm)).call(this,
	props));
	_this.state={
	loading:false,
	'fileList':[],
	...
	['handleSubmit','uploadChange'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(DelegateForm,[{key:'handleSubmit',value:function handleSubmit()
	...
	if(!err){
	ajax({
	url:"/project/deliverFund",
	data:that.state.fileList.length>0?(0,_extends3.default)(values,{accessory:that.state.fileList[0].url}):values,
	callback:function callback(data){
	_antd.message.success("投递成功!",1,function(){
	that.props.deliverCallback();
	});
	}});
	...
	_react2.default.createElement(TextArea,{rows:6,placeholder:'\u8BF7\u8F93\u5165\u60A8\u7684\u6295\u9012\u5185\u5BB9'}))),
	
	
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Col,{span:4},'\u9644\u4EF6:'),
	_react2.default.createElement(_antd.Col,{span:20},
	_react2.default.createElement(FormItem,null,
	...
	_react2.default.createElement(_antd.Col,{span:8,offset:1},
	_react2.default.createElement(_antd.Button,{type:'default',onClick:this.props.hideDeliverModal,style:{width:'100%'}},'\u53D6\u6D88')))));
	
	
	
	
	}}]);return DelegateForm;}(_react2.default.Component);
	
	
	var WrappedDelegateForm=_antd.Form.create()(DelegateForm);
	
	module.exports=WrappedDelegateForm;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1326)))

/***/ })

});
//# sourceMappingURL=projectDetail.984cd24f00bd88370831.chunk.js.map