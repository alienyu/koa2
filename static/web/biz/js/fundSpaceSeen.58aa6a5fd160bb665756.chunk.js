...
/***/ (function(module, exports, __webpack_require__) {
	...
	Seen=function(_React$Component){(0,_inherits3.default)(Seen,_React$Component);
	function Seen(props){(0,_classCallCheck3.default)(this,Seen);var _this=(0,_possibleConstructorReturn3.default)(this,(Seen.__proto__||(0,_getPrototypeOf2.default)(Seen)).call(this,
	props));
	_this.state={
	projectList:[],
	current:1,
	...
	['changePage','goToProjectDetail'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(Seen,[{key:'categoryText',value:function categoryText(
	...
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u6211\u67E5\u770B\u7684\u9879\u76EE'),
	_react2.default.createElement(_antd.Row,{className:'projectList'},
	this.state.projectList.map(function(item,index){return(
	_react2.default.createElement(_antd.Row,{onClick:_this2.goToProjectDetail.bind(_this2,item.id,item.feature),className:index%2==0?'each gray':'each',key:item.id},
	...
	}}]);return Seen;}(_react2.default.Component);
...
//# sourceMappingURL=fundSpaceSeen.58aa6a5fd160bb665756.chunk.js.map