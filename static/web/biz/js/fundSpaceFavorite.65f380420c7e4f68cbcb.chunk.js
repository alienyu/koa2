...
/***/ (function(module, exports, __webpack_require__) {
	...
	Favorite=function(_React$Component){(0,_inherits3.default)(Favorite,_React$Component);
	function Favorite(props){(0,_classCallCheck3.default)(this,Favorite);var _this=(0,_possibleConstructorReturn3.default)(this,(Favorite.__proto__||(0,_getPrototypeOf2.default)(Favorite)).call(this,
	props));
	_this.state={
	projectList:[],
	current:1,
	...
	['changePage','goToProjectDetail','deleteFavorite'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(Favorite,[{key:'categoryText',value:function categoryText(
	...
	}},{key:'goToProjectDetail',value:function goToProjectDetail(
	
	id,type){
	_reactRouter.hashHistory.push('/project/detail/'+id+'?type='+type);
	}},{key:'deleteFavorite',value:function deleteFavorite(
	
	id){
	var that=this;
	ajax({
	url:"/fund/favorite/delete",
	data:{id:id},
	callback:function callback(data){
	_antd.message.success("取消收藏成功！",1,function(){
	that.renderPage(1);
	});
	}});
	...
	var that=this;
	ajax({
	url:"/fund/favorite/getInfoList",
	data:{page:page},
	callback:function callback(data){
	that.setState({
	projectList:data.infoList,
	total:data.total});
	...
	{var _this2=this;
	return(
	_react2.default.createElement(_antd.Row,{className:'seenFrame'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u6211\u6536\u85CF\u7684\u9879\u76EE'),
	_react2.default.createElement(_antd.Row,{className:'projectList'},
	this.state.projectList.map(function(item,index){return(
	_react2.default.createElement(_antd.Row,{className:index%2==0?'each gray':'each',key:item.id},
	_react2.default.createElement(_antd.Col,{span:20},
	_react2.default.createElement(_antd.Row,{onClick:_this2.goToProjectDetail.bind(_this2,item.id,item.feature)},
	...
	_react2.default.createElement('span',{className:item.status==1?'':'disabledText'},item.region))),
	
	
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(_antd.Row,{className:'item'},'\u9879\u76EE\u7C7B\u578B:',
	_react2.default.createElement('span',{className:item.status==1?'redText':'disabledText'},item.type)),
	
	_react2.default.createElement(_antd.Row,{className:'item'},'\u878D\u8D44\u989D\u5EA6:',
	_react2.default.createElement('span',{className:item.status==1?'redText':'disabledText'},item.financingNum,'\u4E07\u5143'))),
	
	
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(_antd.Row,{className:'item'},'\u6240\u5C5E\u884C\u4E1A:',
	_react2.default.createElement('span',{className:item.status==1?'':'disabledText'},item.industry)),
	...
	_react2.default.createElement(_antd.Popconfirm,{title:'\u662F\u5426\u786E\u8BA4\u5220\u9664\uFF1F',onConfirm:_this2.deleteFavorite.bind(_this2,''+item.id),okText:'\u662F',cancelText:'\u5426'},
	...
	}}]);return Favorite;}(_react2.default.Component);
...
//# sourceMappingURL=fundSpaceFavorite.65f380420c7e4f68cbcb.chunk.js.map