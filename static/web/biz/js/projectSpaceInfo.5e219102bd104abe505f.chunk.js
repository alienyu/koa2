...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _infoForm=__webpack_require__(1605);var _infoForm2=_interopRequireDefault(_infoForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
	
	Info=function(_React$Component){(0,_inherits3.default)(Info,_React$Component);
	function Info(props){(0,_classCallCheck3.default)(this,Info);return(0,_possibleConstructorReturn3.default)(this,(Info.__proto__||(0,_getPrototypeOf2.default)(Info)).call(this,
	props));
	}(0,_createClass3.default)(Info,[{key:'render',value:function render()
	
	{
	return(
	_react2.default.createElement(_infoForm2.default,null));
	
	}}]);return Info;}(_react2.default.Component);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	InfoForm=function(_React$Component){(0,_inherits3.default)(InfoForm,_React$Component);
	function InfoForm(props){(0,_classCallCheck3.default)(this,InfoForm);var _this=(0,_possibleConstructorReturn3.default)(this,(InfoForm.__proto__||(0,_getPrototypeOf2.default)(InfoForm)).call(this,
	props));_this.
	...
	handleCancel=function(){return _this.setState({previewVisible:false});};_this.state={personalInfo:{firstName:"",lastName:"",cuteName:"",avatarImg:"",gender:1,region:"",cascaderRegion:[],companyName:"",department:"",position:"",companyInfo:"",phone:"",mobile:"",mobileShow:0,email:""},fileList:[],previewVisible:false,previewImage:''};['handleSubmit','handlePreview','uploadChange','handleCancel'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;}(0,_createClass3.default)(InfoForm,[{key:'handlePreview',value:function handlePreview(file){this.setState({previewImage:file.url||file.thumbUrl,previewVisible:true});}},{key:'uploadChange',value:function uploadChange(info){var that=this;var file=info.file;var fileList=info.fileList;if(fileList.length>0){if(fileList.length>1){fileList=[file];}if(fileList[0].status=="error"){fileList=[];_antd.message.error("上传图片失败!");}if(fileList[0].status=="done"){fileList[0].url=''+fileList[0].response.url;}}this.setState({fileList:fileList});}},{key:'handleSubmit',value:function handleSubmit()
	
	{var _this2=this;
	var that=this;
	this.props.form.validateFieldsAndScroll(function(err,values){
	if(!err){
	if(that.state.fileList.length>0&&_this2.state.fileList[0].url){
	ajax({
	url:"/info/setPersonalInfo",
	data:(0,_extends3.default)(values,{
	avatarImg:_this2.state.fileList[0].url,
	...
	var that=this;
	ajax({
	url:"/info/getPersonalInfo",
	callback:function callback(data){
	var defaultRegion=[];
	var defaultAvatar=[];
	if(data.basicInfo.regionSelectedResult){
	defaultRegion.push(data.basicInfo.regionSelectedResult.substr(0,2));
	defaultRegion.push(data.basicInfo.regionSelectedResult.substr(2,2));
	
	defaultRegion.push(data.basicInfo.regionSelectedResult.substr(4,2));
	}
	if(data.basicInfo.avatarImg){
	defaultAvatar=[{
	uid:-1,
	name:"avatar.png",
	status:'done',
	url:data.basicInfo.avatarImg}];
	
	}
	that.setState({
	personalInfo:(0,_extends3.default)(data.basicInfo,{region:defaultRegion}),
	...
	{var _state=
	this.state,previewVisible=_state.previewVisible,previewImage=_state.previewImage,fileList=_state.fileList;
	var uploadButton=
	_react2.default.createElement('div',null,
	_react2.default.createElement(_antd.Icon,{type:'plus'}),
	_react2.default.createElement('div',{className:'ant-upload-text'},'Upload'));var
	
	
	getFieldDecorator=this.props.form.getFieldDecorator;
	
	return(
	_react2.default.createElement(_antd.Row,{className:'infoFrame'},
	_react2.default.createElement(_antd.Row,{className:'projectSpaceInfoFormTitle'},'\u57FA\u672C\u4FE1\u606F\uFF08\u5FC5\u586B\uFF09'),
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u771F\u5B9E\u59D3\u540D'),
	_react2.default.createElement(_antd.Col,{span:4},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	getFieldDecorator("firstName",{
	rules:[{
	required:true,
	message:"请输入姓!"}],
	
	initialValue:this.state.personalInfo.firstName})(
	
	_react2.default.createElement(_antd.Input,{type:'text',placeholder:'\u8BF7\u8F93\u5165\u59D3'})))),
	...
	initialValue:this.state.personalInfo.lastName})(
	
	_react2.default.createElement(_antd.Input,{type:'text',placeholder:'\u8BF7\u8F93\u5165\u540D'}))))),
	
	
	
	
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u5934\u50CF'),
	_react2.default.createElement(_antd.Col,{span:4},
	...
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u6635\u79F0'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	getFieldDecorator('cuteName',{
	rules:[{
	required:true,
	message:"请输入昵称!"}],
	
	initialValue:this.state.personalInfo.cuteName})(
	
	_react2.default.createElement(_antd.Input,{type:'text',placeholder:'\u8BF7\u8F93\u5165\u6635\u79F0'}))))),
	
	
	
	
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u6027\u522B'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	...
	initialValue:this.state.personalInfo.gender.toString()})(
	
	_react2.default.createElement(_antd.Select,{style:{width:'100%'}},
	_react2.default.createElement(Option,{value:'1'},'\u7537'),
	_react2.default.createElement(Option,{value:'2'},'\u5973')))))),
	...
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u5730\u533A'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	...
	initialValue:this.state.personalInfo.region})(
	
	_react2.default.createElement(_antd.Cascader,{options:this.state.personalInfo.cascaderRegion,placeholder:'\u8BF7\u9009\u62E9\u5730\u533A'}))))),
	
	
	
	
	
	_react2.default.createElement(_antd.Row,{className:'projectSpaceInfoFormTitle'},'\u516C\u53F8\u4FE1\u606F\uFF08*\u4E3A\u5FC5\u586B\uFF09'),
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},_react2.default.createElement('i',null,'*'),'\u516C\u53F8\u540D\u79F0'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	...
	initialValue:this.state.personalInfo.companyName})(
	
	_react2.default.createElement(_antd.Input,{type:'text',placeholder:'\u8BF7\u8F93\u5165\u516C\u53F8\u540D\u79F0'}))))),
	...
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},_react2.default.createElement('i',null,'*'),'\u90E8\u95E8'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	...
	initialValue:this.state.personalInfo.department})(
	
	_react2.default.createElement(_antd.Input,{type:'text',placeholder:'\u8BF7\u8F93\u5165\u90E8\u95E8'}))))),
	...
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},_react2.default.createElement('i',null,'*'),'\u804C\u4F4D'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	...
	initialValue:this.state.personalInfo.position})(
	
	_react2.default.createElement(_antd.Input,{type:'text',placeholder:'\u8BF7\u8F93\u5165\u804C\u4F4D'}))))),
	...
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u516C\u53F8\u7B80\u4ECB'),
	_react2.default.createElement(_antd.Col,{span:12},
	_react2.default.createElement(FormItem,null,
	getFieldDecorator('companyInfo',{
	initialValue:this.state.personalInfo.companyInfo})(
	
	_react2.default.createElement(TextArea,{rows:8,placeholder:'\u8BF7\u8F93\u5165\u516C\u53F8\u7B80\u4ECB'}))))),
	
	
	
	
	
	_react2.default.createElement(_antd.Row,{className:'projectSpaceInfoFormTitle'},'\u8054\u7CFB\u65B9\u5F0F\uFF08\u5FC5\u586B\uFF09'),
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u56FA\u5B9A\u7535\u8BDD'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	...
	initialValue:this.state.personalInfo.phone})(
	
	_react2.default.createElement(_antd.Input,{type:'text',placeholder:'\u8BF7\u8F93\u5165\u56FA\u5B9A\u7535\u8BDD'}))))),
	...
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u624B\u673A\u53F7\u7801'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	...
	initialValue:this.state.personalInfo.mobile})(
	...
	_react2.default.createElement(FormItem,{hasFeedback:true},
	getFieldDecorator('mobileShow',{
	initialValue:this.state.personalInfo.mobileShow})(
	
	_react2.default.createElement(RadioGroup,null,
	_react2.default.createElement(_antd.Radio,{value:1},'\u4F1A\u5458\u53EF\u89C1'),
	_react2.default.createElement(_antd.Radio,{value:0},'\u4F1A\u5458\u4E0D\u53EF\u89C1')))))),
	...
	_react2.default.createElement(_antd.Row,{className:'formLine'},
	_react2.default.createElement(_antd.Col,{span:4,offset:1,className:'label'},'\u90AE\u7BB1'),
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(FormItem,{hasFeedback:true},
	...
	initialValue:this.state.personalInfo.email})(
	
	_react2.default.createElement(_antd.Input,{type:'text',placeholder:'\u8BF7\u8F93\u5165\u90AE\u7BB1'}))))),
	...
	_react2.default.createElement(_antd.Col,{span:5,offset:5},
	_react2.default.createElement(_antd.Button,{type:'primary',style:{width:'100%'},onClick:this.handleSubmit},'\u4FDD\u5B58\u4FE1\u606F'))),
	
	
	_react2.default.createElement(_antd.Modal,{visible:previewVisible,footer:null,onCancel:this.handleCancel},
	_react2.default.createElement('img',{alt:'example',style:{width:'100%'},src:previewImage}))));
	
	
	
	
	}}]);return InfoForm;}(_react2.default.Component);
	
	
	var WrappedInfoForm=_antd.Form.create()(InfoForm);
	
	module.exports=WrappedInfoForm;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1326)))

/***/ })

});
//# sourceMappingURL=projectSpaceInfo.5e219102bd104abe505f.chunk.js.map