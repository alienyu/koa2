...
/***/ (function(module, exports, __webpack_require__) {
	...
	Deliver=function(_React$Component){(0,_inherits3.default)(Deliver,_React$Component);
	function Deliver(props){(0,_classCallCheck3.default)(this,Deliver);var _this=(0,_possibleConstructorReturn3.default)(this,(Deliver.__proto__||(0,_getPrototypeOf2.default)(Deliver)).call(this,
	props));
	_this.state={
	deliverList:[],
	current:1,
	...
	_this.tableColumns=[{
	title:'委托资金标题',
	render:function render(data){return _react2.default.createElement(_reactRouter.Link,{to:'/project/detail/'+data.id+'?type=delegate'},data.title);}},
	{
	title:'投递时间',
	dataIndex:'time',
	key:'time'},
	...
	{
	title:'投递文件',
	render:function render(data){return _react2.default.createElement('a',{href:data.accessory.link},data.accessory.name);}},
	{
	title:"操作",
	render:function render(data){return _react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteDeliver.bind(_this,data.id),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},_react2.default.createElement(_antd.Button,{type:'danger'},'\u5220\u9664'));}}];
	
	['deleteDeliver','changePage','renderPage'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(Deliver,[{key:'deleteDeliver',value:function deleteDeliver(
	
	id){
	var that=this;
	ajax({
	url:"/project/deliver/delete",
	data:{id:id},
	...
	var that=this;
	ajax({
	url:"/project/deliver/getInfoList",
	data:{page:page},
	callback:function callback(data){
	that.setState({
	current:page,
	total:data.total,
	deliverList:data.infoList});
	...
	{
	return(
	_react2.default.createElement(_antd.Row,{className:'deliverFrame'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u6211\u7684\u6295\u9012'),
	_react2.default.createElement(_antd.Table,{
	rowKey:'id',
	dataSource:this.state.deliverList,
	...
	}}]);return Deliver;}(_react2.default.Component);
	;
...
//# sourceMappingURL=projectSpaceDeliver.0248909d4f2f265026a8.chunk.js.map