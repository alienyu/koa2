...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _enrollForm=__webpack_require__(1493);var _enrollForm2=_interopRequireDefault(_enrollForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
	...
	}(0,_createClass3.default)(List,[{key:'renderPage',value:function renderPage(
	
	page){
	var that=this;
	ajax({
	url:"/about/getReportList",
	data:{page:page},
	callback:function callback(data){
	that.setState({
	reportList:data.infoList,
	total:data.total});
	...
	{
	return(
	_react2.default.createElement(_antd.Row,{className:'activityEnroll'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u4FE1\u606F\u586B\u5199'),
	_react2.default.createElement(_enrollForm2.default,{activityID:this.props.params.id})));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	EnrollForm=function(_React$Component){(0,_inherits3.default)(EnrollForm,_React$Component);
	function EnrollForm(props){(0,_classCallCheck3.default)(this,EnrollForm);var _this=(0,_possibleConstructorReturn3.default)(this,(EnrollForm.__proto__||(0,_getPrototypeOf2.default)(EnrollForm)).call(this,
	props));
	_this.provinceList={
	"110000":"北京市",
	"120000":"天津市",
	...
	}(0,_createClass3.default)(EnrollForm,[{key:'handleSubmit',value:function handleSubmit()
	...
	data:values,
	callback:function callback(data){
	_antd.message.success("报名成功!",1,function(){
	_reactRouter.hashHistory.push('/activity/detail/'+that.props.activityID+'/success?type='+data.type+'&person='+values.number);
	});
	}});
	...
	regionOps.push(_react2.default.createElement(Option,{key:key,value:key},this.provinceList[key]));
	}
	
	return(
	_react2.default.createElement(_antd.Row,{type:'flex',justify:'center',className:'enrollForm'},
	...
	_react2.default.createElement(_antd.Input,{placeholder:'\u8BF7\u8F93\u5165\u53C2\u4F1A\u8005\u59D3\u540D\uFF0C\u591A\u4EBA\u62A5\u540D\u8BF7\u7528\'\u3001\'\u5206\u5F00'}))),
	...
	_react2.default.createElement(_antd.Input,{placeholder:'\u8BF7\u8F93\u5165\u60A8\u516C\u53F8\u7684\u53D1\u7968\u62AC\u5934\u540D\u79F0'}))),
	...
	_react2.default.createElement(_antd.Input,{placeholder:'\u8BF7\u8F93\u5165\u60A8\u516C\u53F8\u7684\u7EB3\u7A0E\u4EBA\u8BC6\u522B\u53F7\uFF08\u514D\u8D39\u6D3B\u52A8\u6216\u65E0\u9700\u53D1\u7968\u4E0D\u7528\u586B\uFF09'}))),
	...
	_react2.default.createElement(_antd.Select,{placeholder:'\u8BF7\u9009\u62E9\u6240\u5C5E\u5730\u533A'},
	regionOps))),
	...
	_react2.default.createElement(_antd.Input,{placeholder:'\u8BF7\u8F93\u5165\u60A8\u7684\u624B\u673A\u53F7\u7801'}))),
	...
	_react2.default.createElement(_antd.Input,{type:'number',placeholder:'\u8BF7\u8F93\u5165\u60A8\u7684\u62A5\u540D\u4EBA\u6570',suffix:'\u4EBA'}))),
	
	
	_react2.default.createElement(_antd.Row,{type:'flex',justify:'center'},
	_react2.default.createElement(_antd.Col,{span:8},
	_react2.default.createElement(_antd.Button,{type:'primary',className:'enrollBtn',onClick:this.handleSubmit},'\u62A5\u540D')))))));
	...
	}}]);return EnrollForm;}(_react2.default.Component);
	
	
	var WrappedEnrollForm=_antd.Form.create()(EnrollForm);
	
	module.exports=WrappedEnrollForm;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1326)))

/***/ })

});
//# sourceMappingURL=activityEnroll.2871c7b198ef1333f93f.chunk.js.map