...
/***/ (function(module, exports, __webpack_require__) {
	...
	['goToEnroll'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	...
	}},{key:'goToEnroll',value:function goToEnroll()
	
	{
	_reactRouter.hashHistory.push('/activity/detail/'+this.props.params.id+'/enroll');
	}},{key:'render',value:function render()
	
	{
	var info=this.state.info;
	var detailInfo=info.info;
	return(
	_react2.default.createElement(_antd.Row,{className:'activityDetail'},
	_react2.default.createElement(_antd.Row,{className:'title',type:'flex',justify:'center',align:'middle'},info.title),
	_react2.default.createElement(_antd.Row,{className:'date',type:'flex',justify:'center',align:'middle'},
	_react2.default.createElement(_antd.Col,{span:8,style:{textAlign:'center'}},'\u65F6\u95F4:\xA0',info.date,'\xA0\xA0\xA0\u6765\u6E90:\xA0',info.source)),
	
	_react2.default.createElement(_antd.Row,{className:'content',dangerouslySetInnerHTML:{__html:info.content}}),
	info.img?_react2.default.createElement(_antd.Row,{className:'activityImg'},
	_react2.default.createElement('img',{src:info.img})):
	"",
	_react2.default.createElement(_antd.Row,{className:'info'},
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Col,{span:2},'\u5F00\u59CB\u65F6\u95F4:'),
	_react2.default.createElement(_antd.Col,{span:4},detailInfo.startTime),
	_react2.default.createElement(_antd.Col,{span:2},'\u7ED3\u675F\u65F6\u95F4:'),
	_react2.default.createElement(_antd.Col,{span:4},detailInfo.endTime)),
	
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Col,{span:2},'\u5730\u5740:'),
	_react2.default.createElement(_antd.Col,{span:20},detailInfo.address)),
	
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Col,{span:2},'\u9080\u8BF7\u5609\u5BBE:'),
	_react2.default.createElement(_antd.Col,{span:20},detailInfo.invited)),
	
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Col,{span:2},'\u54A8\u8BE2\u8054\u7CFB:'),
	_react2.default.createElement(_antd.Col,{span:20},detailInfo.phone)),
	
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Col,{span:2},'\u8D39\u7528:'),
	_react2.default.createElement(_antd.Col,{span:20},detailInfo.fees,'\u5143/\u4EBA')),
	
	_react2.default.createElement(_antd.Row,null,
	_react2.default.createElement(_antd.Col,{span:2},'\u4EBA\u6570:'),
	_react2.default.createElement(_antd.Col,{span:20},detailInfo.limitNum,'\u4EBA'))),
	
	
	_react2.default.createElement(_antd.Row,{type:'flex',justify:'center'},
	_react2.default.createElement(_antd.Col,{span:6},
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:this.goToEnroll,className:'enrollBtn'},'\u6211\u8981\u62A5\u540D')))));
...
//# sourceMappingURL=activityDetail.ae8ee13f9ebc78e3f6d0.chunk.js.map