...
/***/ (function(module, exports, __webpack_require__) {
	...
	{
	return(
	_react2.default.createElement(_antd.Row,{className:'reportListFrame'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u5A92\u4F53\u62A5\u9053'),
	_react2.default.createElement(_antd.Row,{className:'list'},
	this.state.reportList.map(function(item){return(
	_react2.default.createElement(_antd.Row,{className:'each',key:item.id},
	_react2.default.createElement(_antd.Row,{className:'lineFirst'},
	_react2.default.createElement(_antd.Col,{span:20,className:'title'},_react2.default.createElement(_reactRouter.Link,{to:'/about/report/'+item.id},item.title)),
	_react2.default.createElement(_antd.Col,{span:4,className:'date'},item.date)),
	
	_react2.default.createElement(_antd.Row,{className:'text'},item.abstractContent)));})),
...
//# sourceMappingURL=reportList.b8e82b249075ce87c7cf.chunk.js.map