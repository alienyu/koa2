...
/***/ (function(module, exports, __webpack_require__) {
	...
	{
	return(
	_react2.default.createElement(_antd.Row,{className:'noticeDetail'},
	...
	_react2.default.createElement(_antd.Col,{span:8,style:{textAlign:'center'}},'\u65F6\u95F4:',this.state.date.split("-")[0],'\u5E74',this.state.date.split("-")[1],'\u6708',this.state.date.split("-")[2],'\u65E5\xA0\xA0',this.state.source)),
...
//# sourceMappingURL=noticeDetail.79e14e4137ef1b96b7c7.chunk.js.map