...
/***/ (function(module, exports, __webpack_require__) {
	...
	data){
	if(data.status){
	return data.name+', '+data.company+', '+data.department+', '+data.position+', '+(data.mobile?'手机:'+data.mobile:'')+', '+(data.email?'邮箱:'+data.email:'')+', \u67E5\u770B\u4E86\u60A8\u7684\u8D44\u91D1';
	}else{
	return data.name+', \u67E5\u770B\u4E86\u60A8\u7684\u8D44\u91D1';
	}
	}},{key:'getFundLink',value:function getFundLink(
	
	data){
	return _react2.default.createElement(_reactRouter.Link,{to:'/fund/detail/'+data.fundDetail.id+'?type=normal'},data.fundDetail.name);
	}},{key:'renderPage',value:function renderPage(
	
	page){
	var that=this;
	ajax({
	url:"/fund/feedback/getInfoList",
	data:{page:page},
	...
	_this2.getContent(item),_this2.getFundLink(item),',\u8BF7\u5C3D\u5FEB\u4E0E\u4ED6\u8054\u7CFB\u3002',
	item.status?null:
...
//# sourceMappingURL=fundSpaceFeedback.7f11ea947c27c8712000.chunk.js.map