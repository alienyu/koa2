...
/***/ (function(module, exports, __webpack_require__) {
	...
	_reactRouter.hashHistory.push('/project/space/publish/'+type+'?id='+id);
	}},{key:'deletePublished',value:function deletePublished(
	
	id){
	var that=this;
	ajax({
	url:"/project/published/delete",
	data:{id:id},
	...
	var that=this;
	ajax({
	url:"/project/published/getInfoList",
	data:{page:page},
	callback:function callback(data){
	that.setState({
	...
	var that=this;
	ajax({
	url:"/project/published/setProcess",
	...
	{var _this2=this;
	return(
	_react2.default.createElement(_antd.Row,{className:'publishedFrame'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u6211\u53D1\u5E03\u7684\u9879\u76EE'),
	...
	_react2.default.createElement(_antd.Row,{className:'fundTitle'},_react2.default.createElement(_reactRouter.Link,{to:'/project/detail/'+item.id+'type=normal'},item.title),
	...
	_react2.default.createElement(_antd.Row,{className:'item'},'\u9879\u76EE\u7C7B\u522B:',
	_react2.default.createElement('span',{className:'redText content'},_this2.categoryText(item.category))),
	
	_react2.default.createElement(_antd.Row,{className:'item'},'\u6240\u5728\u5730\u533A:',
	_react2.default.createElement('span',{className:'content'},item.region))),
	
	
	_react2.default.createElement(_antd.Col,{span:9},
	_react2.default.createElement(_antd.Row,{className:'item'},'\u9879\u76EE\u7C7B\u578B:',
	_react2.default.createElement('span',{className:'redText content'},item.type)),
	
	_react2.default.createElement(_antd.Row,{className:'item'},'\u878D\u8D44\u989D\u5EA6:',
	...
	_react2.default.createElement(_antd.Row,{className:'item'},'\u6240\u5C5E\u884C\u4E1A:',
...
//# sourceMappingURL=projectSpacePublished.6f4f856cf5c14690dec9.chunk.js.map