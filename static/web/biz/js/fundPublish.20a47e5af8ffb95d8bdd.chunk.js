...
/***/ (function(module, exports, __webpack_require__) {
	...
	Publish=function(_React$Component){(0,_inherits3.default)(Publish,_React$Component);
	function Publish(props){(0,_classCallCheck3.default)(this,Publish);return(0,_possibleConstructorReturn3.default)(this,(Publish.__proto__||(0,_getPrototypeOf2.default)(Publish)).call(this,
	props));
	}(0,_createClass3.default)(Publish,[{key:'render',value:function render()
	
	{
	return(
	_react2.default.createElement(_antd.Row,{className:'fundPublishFrame'},
	this.props.children));
	
	
	}}]);return Publish;}(_react2.default.Component);
...
//# sourceMappingURL=fundPublish.20a47e5af8ffb95d8bdd.chunk.js.map