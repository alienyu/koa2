...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _feedbackForm=__webpack_require__(1478);var _feedbackForm2=_interopRequireDefault(_feedbackForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
	
	Feedback=function(_React$Component){(0,_inherits3.default)(Feedback,_React$Component);
	function Feedback(props){(0,_classCallCheck3.default)(this,Feedback);return(0,_possibleConstructorReturn3.default)(this,(Feedback.__proto__||(0,_getPrototypeOf2.default)(Feedback)).call(this,
	props));
	}(0,_createClass3.default)(Feedback,[{key:'render',value:function render()
	
	{
	var feedbackBG=__webpack_require__(1479);
	return(
	_react2.default.createElement(_antd.Row,{className:'feedbackFrame'},
	_react2.default.createElement(_antd.Row,{className:'feedbackBG'},
	_react2.default.createElement('img',{src:feedbackBG})),
	
	_react2.default.createElement(_antd.Row,{className:'prompt'},'\u8BF7\u8BE6\u7EC6\u63CF\u8FF0\u60A8\u6240\u9047\u5230\u7684\u95EE\u9898,\u8981\u63D0\u51FA\u7684\u610F\u89C1'),
	_react2.default.createElement(_feedbackForm2.default,null)));
	
	
	}}]);return Feedback;}(_react2.default.Component);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	FeedbackForm=function(_React$Component){(0,_inherits3.default)(FeedbackForm,_React$Component);
	function FeedbackForm(props){(0,_classCallCheck3.default)(this,FeedbackForm);var _this=(0,_possibleConstructorReturn3.default)(this,(FeedbackForm.__proto__||(0,_getPrototypeOf2.default)(FeedbackForm)).call(this,
	props));
	_this.state={
	inputNum:500};
	
	['handleSubmit','calWordNum'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	
	}(0,_createClass3.default)(FeedbackForm,[{key:'handleSubmit',value:function handleSubmit()
	...
	}},{key:'calWordNum',value:function calWordNum(
	
	e){
	this.setState({
	inputNum:500-e.target.value.length});
	...
	return(
	_react2.default.createElement(_antd.Row,{className:'formFrame'},
	_react2.default.createElement(_antd.Form,null,
	_react2.default.createElement(_antd.Col,{span:11},
	...
	_react2.default.createElement(TextArea,{placeholder:'\u8BF7\u8F93\u5165\u60A8\u8981\u53D1\u8868\u7684\u5EFA\u8BAE',rows:14,style:{resize:'none'},onChange:this.calWordNum}))),
	
	
	_react2.default.createElement(_antd.Row,{className:'inputPrompt'},'\u8FD8\u53EF\u8F93',_react2.default.createElement('i',null,this.state.inputNum),'\u5B57')),
	
	_react2.default.createElement(_antd.Col,{span:11,offset:2},
	_react2.default.createElement(FormItem,{
	hasFeedback:true},
	...
	_react2.default.createElement(_antd.Input,{placeholder:'\u8BF7\u5728\u6B64\u8F93\u5165\u60A8\u7684\u59D3\u540D',prefix:'\u59D3\u540D:'}))),
	...
	_react2.default.createElement(_antd.Input,{placeholder:'\u8BF7\u5728\u6B64\u8F93\u5165\u60A8\u7684\u7535\u8BDD',prefix:'\u7535\u8BDD:'}))),
	...
	_react2.default.createElement(_antd.Input,{placeholder:'\u8BF7\u5728\u6B64\u8F93\u5165\u60A8\u7684\u90AE\u7BB1',prefix:'\u90AE\u7BB1:'}))),
	
	
	_react2.default.createElement(_antd.Row,{type:'flex',justify:'center'},
	_react2.default.createElement(FormItem,null,
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:this.handleSubmit,style:{width:200}},'\u63D0\u4EA4')))))));
	...
	}}]);return FeedbackForm;}(_react2.default.Component);
	
	
	var WrappedFeedbackForm=_antd.Form.create()(FeedbackForm);
	
	module.exports=WrappedFeedbackForm;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "common/imgs/d37e037771147cbca2ce44e40b1f6ced.png";

/***/ })

});
//# sourceMappingURL=feedback.dc0ee22e39744206fadb.chunk.js.map