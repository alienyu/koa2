...
/***/ (function(module, exports, __webpack_require__) {
	...
	{
	return(
	_react2.default.createElement(_antd.Row,{className:'noticeList'},
	_react2.default.createElement(_antd.Row,{className:'list'},
	this.state.noticeList.map(function(item){return(
	_react2.default.createElement(_antd.Row,{className:'line',key:item.id},
	_react2.default.createElement(_antd.Col,{span:20,className:'title'},_react2.default.createElement(_reactRouter.Link,{to:'/notice/detail/'+item.id},item.title)),
	_react2.default.createElement(_antd.Col,{span:4,className:'date'},'\u65F6\u95F4:',item.date)));})),
...
//# sourceMappingURL=noticeList.15d3b0af7ebcb03c11e1.chunk.js.map