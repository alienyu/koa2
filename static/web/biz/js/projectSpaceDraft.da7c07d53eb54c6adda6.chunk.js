...
/***/ (function(module, exports, __webpack_require__) {
	...
	Draft=function(_React$Component){(0,_inherits3.default)(Draft,_React$Component);
	function Draft(props){(0,_classCallCheck3.default)(this,Draft);var _this=(0,_possibleConstructorReturn3.default)(this,(Draft.__proto__||(0,_getPrototypeOf2.default)(Draft)).call(this,
	props));
	_this.state={
	draftList:[],
	current:1,
	...
	['goToEdit','deleteDraft','changePage'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	
	}(0,_createClass3.default)(Draft,[{key:'categoryText',value:function categoryText(
	...
	}},{key:'deleteDraft',value:function deleteDraft(
	
	id){
	var that=this;
	ajax({
	url:"/project/draft/delete",
	data:{id:id},
	...
	var that=this;
	ajax({
	url:"/project/draft/getInfoList",
	data:{page:page},
	callback:function callback(data){
	that.setState({
	draftList:data.infoList,
	total:data.total});
	...
	{var _this2=this;
	return(
	_react2.default.createElement(_antd.Row,{className:'draftFrame'},
	_react2.default.createElement(_antd.Row,{className:'menuTitle'},'\u9879\u76EE\u8349\u7A3F'),
	_react2.default.createElement(_antd.Row,{className:'draftList'},
	this.state.draftList.map(function(item){return(
	...
	_react2.default.createElement(_antd.Row,{className:'projectTitle'},item.title),
	...
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:_this2.goToEdit.bind(_this2,''+item.id,''+item.category)},'\u7F16\u8F91')),
	
	_react2.default.createElement(_antd.Col,{span:9,offset:2},
	_react2.default.createElement(_antd.Popconfirm,{title:'\u662F\u5426\u786E\u8BA4\u5220\u9664\uFF1F',onConfirm:_this2.deleteDraft.bind(_this2,''+item.id),okText:'\u662F',cancelText:'\u5426'},
	...
	}}]);return Draft;}(_react2.default.Component);
...
//# sourceMappingURL=projectSpaceDraft.da7c07d53eb54c6adda6.chunk.js.map