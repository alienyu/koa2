...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _searchForm=__webpack_require__(1389);var _searchForm2=_interopRequireDefault(_searchForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var Content=_antd.Layout.Content;var
	...
	title:'性别',
	dataIndex:'gender',
	render:function render(gender){return gender==0?"男":"女";}},
	{
	title:'公司名称',
	...
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:_this.checkAudit.bind(_this,data.key),style:{"marginRight":"20px"}},'\u5BA1\u6838'),
	
	_react2.default.createElement(_antd.Button,{onClick:_this.checkUserDetail.bind(_this,data.key),style:{"marginRight":"20px"}},'\u67E5\u770B'),
	
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteUser.bind(_this,data.key),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	_react2.default.createElement(_antd.Button,{style:{marginRight:20},type:'danger'},'\u5220\u9664')),
	
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u6B64\u64CD\u4F5C?',onConfirm:_this.setForbidden.bind(_this,data),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	_react2.default.createElement(_antd.Button,{type:data.forbidden?'default':'danger',style:{backgroundColor:data.forbidden?'green':'',color:data.forbidden?'#fff':''}},data.forbidden?"解禁":"禁言")));}}],
	...
	['changePage','handleSearch','showLoading','hideLoading'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	...
	}},{key:'checkAudit',value:function checkAudit(
	
	key){
	_reactRouter.hashHistory.push("/user/manage/audit/"+key);
	}},{key:'checkUserDetail',value:function checkUserDetail(
	
	key){
	_reactRouter.hashHistory.push("/user/manage/detail/"+key);
	}},{key:'setForbidden',value:function setForbidden(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_react2.default.createElement(_antd.Input,{placeholder:'\u8BF7\u8F93\u5165\u516C\u53F8\u6216\u59D3\u540D'}))),
	...
	_react2.default.createElement(Option,{value:'1'},'\u9879\u76EE\u65B9'),
	_react2.default.createElement(Option,{value:'2'},'\u8D44\u91D1\u65B9')))),
	...
	_react2.default.createElement(_antd.Select,null,
	_react2.default.createElement(Option,{value:'0'},'\u6240\u6709'),
	_react2.default.createElement(Option,{value:'1'},'\u5DF2\u8BA4\u8BC1'),
	_react2.default.createElement(Option,{value:'2'},'\u5F85\u5BA1\u6838'),
	_react2.default.createElement(Option,{value:'3'},'\u672A\u901A\u8FC7')))),
...
//# sourceMappingURL=user_manage_list.ff2830fddd376498f2d2.chunk.js.map