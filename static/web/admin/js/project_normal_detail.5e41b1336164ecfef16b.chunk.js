...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _debtsForm=__webpack_require__(1418);var _debtsForm2=_interopRequireDefault(_debtsForm);
	var _stockForm=__webpack_require__(1419);var _stockForm2=_interopRequireDefault(_stockForm);
	var _transferForm=__webpack_require__(1421);var _transferForm2=_interopRequireDefault(_transferForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var Content=_antd.Layout.Content;var
	...
	this.props.location.query.assetsType==1?_react2.default.createElement(_debtsForm2.default,{infoID:this.props.params.id,actionType:'detail'}):this.props.location.query.assetsType==2?_react2.default.createElement(_stockForm2.default,{infoID:this.props.params.id,actionType:'detail'}):_react2.default.createElement(_transferForm2.default,{infoID:this.props.params.id,actionType:'detail'}))));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_react2.default.createElement(_antd.Select,{disabled:true,defaultValue:'1'},
	...
	_react2.default.createElement(_antd.Input,{style:{width:"95%"},disabled:true,value:this.state.financing.previousProfits}),'\xA0\u4E07\u5143'),
	...
	_react2.default.createElement(_antd.Input,{style:{width:"95%"},disabled:true,value:this.state.financing.number}),'\xA0\u4E07\u5143'),
	...
	_react2.default.createElement(_antd.Input,{style:{width:"95%"},disabled:true,value:this.state.financing.deadline}),'\xA0\u5E74'),
	...
	_react2.default.createElement(_antd.Input,{style:{width:"95%"},disabled:true,value:this.state.financing.maxRate}),'\xA0%'),
	...
	_react2.default.createElement(RadioGroup,{disabled:true,value:this.state.mortgage.isNeed},
	...
	_react2.default.createElement(_antd.Input,{style:{width:"95%"},disabled:true,value:this.state.mortgage.value}),'\xA0\u4E07\u5143'),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u62B5/\u8D28\u62BC\u7269\u6298\u6263\u7387'}),
	
	_react2.default.createElement(_antd.Input,{style:{width:"95%"},disabled:true,value:this.state.mortgage.rate}),'\xA0%'),
	...
	_react2.default.createElement(RadioGroup,{disabled:true,value:this.state.guarantee.isNeed},
	_react2.default.createElement(_antd.Radio,{value:'1'},'\u662F'),
	_react2.default.createElement(_antd.Radio,{value:'0'},'\u5426'))),
	...
	_react2.default.createElement('span',{className:'ant-form-text'},_react2.default.createElement('a',{href:this.state.project.accessory.link},this.state.project.accessory.name))),
	...
	_react2.default.createElement(_antd.Radio,{value:'0'},'\u4E0D\u901A\u8FC7'),
	_react2.default.createElement(_antd.Radio,{value:'1'},'\u901A\u8FC7')))):
	...
	this.props.actionType=="audit"?_react2.default.createElement(_antd.Button,{type:'primary',onClick:this.handleSubmit,style:{"marginRight":"20px"}},'\u63D0\u4EA4'):"",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _benefitsItem=__webpack_require__(1420);var _benefitsItem2=_interopRequireDefault(_benefitsItem);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var FormItem=_antd.Form.Item;var Option=_antd.Select.Option;var RadioGroup=_antd.Radio.Group;var TextArea=_antd.Input.TextArea;var
	...
	_react2.default.createElement(_antd.Select,{disabled:true,defaultValue:'2'},
	_react2.default.createElement(Option,{value:'1'},'\u503A\u6743'),
	_react2.default.createElement(Option,{value:'2'},'\u80A1\u6743'),
	_react2.default.createElement(Option,{value:'4'},'\u8D44\u91D1\u8F6C\u8BA9'))),
	...
	_react2.default.createElement(RadioGroup,{disabled:true,value:this.state.stock.type},
	_react2.default.createElement(_antd.Radio,{value:'1'},'\u53C2\u80A1\u578B\u9879\u76EE'),
	_react2.default.createElement(_antd.Radio,{value:'2'},'\u63A7\u80A1\u578B\u9879\u76EE'))),
	...
	_react2.default.createElement(_antd.Select,{disabled:true,value:this.state.stock.property},
	...
	this.state.stock.property=="1"?_react2.default.createElement(FormItem,(0,_extends3.default)({
	required:true},
	formItemLayout,{
	label:'\u6807\u7684\u4F01\u4E1A\u540D\u79F0'}),
	...
	_react2.default.createElement(_antd.Input,{disabled:true,style:{width:"95%"},value:this.state.stock.property=="1"?this.state.target.previousProfits:this.state.financing.previousProfits}),'\xA0\u4E07\u5143'),
	...
	_react2.default.createElement(_antd.Input,{disabled:true,style:{width:"95%"},value:this.state.stock.number}),'\xA0\u4E07\u5143'),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u51FA\u8BA9\u80A1\u6743\u6BD4\u4F8B'}),
	
	_react2.default.createElement(_antd.Input,{disabled:true,style:{width:"95%"},value:this.state.stock.rate}),'\xA0%'),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u4F01\u4E1A\u6574\u4F53\u4F30\u503C'}),
	
	_react2.default.createElement(_antd.Input,{disabled:true,style:{width:"95%"},value:this.state.stock.property=="1"?this.state.target.number:this.state.financing.number}),'\xA0\u4E07\u5143'),
	...
	_react2.default.createElement(_antd.Input,{disabled:true,style:{width:"95%"},value:this.state.stock.property=="1"?this.state.target.recentProfits:this.state.financing.recentProfits}),'\xA0\u4E07\u5143'),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u4F01\u4E1A\u660E\u5E74\u9884\u8BA1\u51C0\u5229\u6DA6'}),
	
	_react2.default.createElement(_antd.Input,{disabled:true,style:{width:"95%"},value:this.state.stock.property=="1"?this.state.target.nextProfits:this.state.financing.nextProfits}),'\xA0\u4E07\u5143'),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _investItem=__webpack_require__(1422);var _investItem2=_interopRequireDefault(_investItem);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var FormItem=_antd.Form.Item;var Option=_antd.Select.Option;var RadioGroup=_antd.Radio.Group;var TextArea=_antd.Input.TextArea;var
	...
	_react2.default.createElement(_antd.Select,{disabled:true,defaultValue:'4'},
	_react2.default.createElement(Option,{value:'1'},'\u503A\u6743'),
	_react2.default.createElement(Option,{value:'2'},'\u80A1\u6743'),
	_react2.default.createElement(Option,{value:'4'},'\u8D44\u91D1\u8F6C\u8BA9'))),
	...
	_react2.default.createElement(_antd.Input,{disabled:true,style:{width:"95%"},value:this.state.assets.number}),'\xA0\u4E07\u5143'),
	...
	_react2.default.createElement(_antd.Input,{disabled:true,style:{width:"95%"},value:this.state.assets.value}),'\xA0\u4E07\u5143'),
...
//# sourceMappingURL=project_normal_detail.5e41b1336164ecfef16b.chunk.js.map