...
/***/ (function(module, exports, __webpack_require__) {
	...
	dataIndex:"img",
	className:"column-width-15",
	render:function render(img){return _react2.default.createElement('img',{src:img,style:{width:'100%'}});}},
	{
	title:'添加时间',
	...
	dataIndex:'status',
	render:function render(status){return status=="0"?"无效":"有效";}},
	{
	title:'链接地址',
	className:"column-width-15",
	dataIndex:'link'},
	...
	_react2.default.createElement(_antd.Button,{type:'default',onClick:_this.goToNoticeDetail.bind(_this,data.key),style:{"marginRight":"20px"}},'\u67E5\u770B'),
	
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:_this.goToNoticeEdit.bind(_this,data.key),style:{"marginRight":"20px"}},'\u4FEE\u6539'),
	
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteNotice.bind(_this,data.key),
	...
	}},{key:'addNotice',value:function addNotice()
	
	{
	_reactRouter.hashHistory.push("/notice/add");
	}},{key:'goToNoticeDetail',value:function goToNoticeDetail(
	
	id){
	_reactRouter.hashHistory.push("/notice/detail/"+id);
	}},{key:'goToNoticeEdit',value:function goToNoticeEdit(
	
	id){
	_reactRouter.hashHistory.push("/notice/edit/"+id);
	}},{key:'deleteNotice',value:function deleteNotice(
	
	id){
	var that=this;
	adminAjax({
	url:"/notice/deleteInfo",
	method:"post",
	data:{id:id},
	callback:function callback(data){
	...
	_react2.default.createElement(_antd.Button,{icon:'plus',onClick:this.addNotice,style:{"marginBottom":"20px"}},'\u6DFB\u52A0\u516C\u544A'),
...
//# sourceMappingURL=notice_list.3e36de5c2975c0a0b614.chunk.js.map