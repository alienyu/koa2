...
/***/ (function(module, exports, __webpack_require__) {
	...
	_react2.default.createElement('div',{className:'divClick',onClick:_this.goToUserDetail.bind(_this,data.userID)},data.userName));}},
	{
	title:"投递内容",
	dataIndex:"content"},
	{
	title:"投递文件",
	render:function render(data){return(
	_react2.default.createElement('div',{className:'divClick',onClick:_this.downloadFile.bind(_this,data.fileLink)},data.fileName));}},
	{
	title:"投递时间",
	dataIndex:"time"},
	{
	...
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:_this.detailInfo.bind(_this,data.id),style:{"marginRight":"20px"}},'\u67E5\u770B'),
	...
	['loadListData','goToUserDetail','detailInfo','deleteInfo','changePage','downloadFile'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	...
	callback:function callback(data){
	that.setState({
	title:that.props.location.query.title,
	pagination:{
	...
	return _react2.default.createElement(_antd.Breadcrumb.Item,{key:index},item.breadcrumbName);
	})),
	...
	_react2.default.createElement(_antd.Row,{style:{marginBottom:20}},'\u59D4\u6258\u8D44\u91D1\u6807\u9898\uFF1A',this.state.title),
...
//# sourceMappingURL=delegateFund_receivedProject_list.94a869fb6c75a979a566.chunk.js.map