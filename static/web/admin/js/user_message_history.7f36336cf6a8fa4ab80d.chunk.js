...
/***/ (function(module, exports, __webpack_require__) {
	...
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteHistory.bind(_this,key),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	...
	}(0,_createClass3.default)(History,[{key:'componentWillMount',value:function componentWillMount()
	
	{
	this.getHistoryList(1);
	}},{key:'getHistoryList',value:function getHistoryList(
	
	currentPage){
	var that=this;
	this.setState({loading:true});
	adminAjax({
	url:"/user/message/getHistoryList",
	method:"post",
	data:{
	...
	}},{key:'deleteHistory',value:function deleteHistory(
	
	key){
	var that=this;
	adminAjax({
	url:"/user/message/deleteHistory",
	method:"post",
	data:{id:key},
	callback:function callback(data){
	...
	_react2.default.createElement(_antd.Button,{icon:'rollback',onClick:this.return,style:{"marginBottom":"20px"}},'\u8FD4\u56DE'),
	...
	}}]);return History;}(_react2.default.Component);
...
//# sourceMappingURL=user_message_history.7f36336cf6a8fa4ab80d.chunk.js.map