...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _editForm=__webpack_require__(1395);var _editForm2=_interopRequireDefault(_editForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var Content=_antd.Layout.Content;var
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_this.sendTo="";
	['handleSubmit','resetForm','sendToChange'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(EditForm,[{key:'handleSubmit',value:function handleSubmit()
	...
	}},{key:'sendToChange',value:function sendToChange(
	...
	_react2.default.createElement(_antd.Select,{onChange:this.sendToChange},
	...
	_react2.default.createElement(Option,{value:'3'},'\u6307\u5B9A\u5BF9\u8C61')))),
	
	
	
	
	this.sendTo=="3"?_react2.default.createElement(FormItem,(0,_extends3.default)({
	required:true},
	formItemLayout,{
	label:'\u624B\u673A\u53F7\u7801\u8868',
	hasFeedback:true}),
...
//# sourceMappingURL=user_message_edit.0d007c1910ccb8039067.chunk.js.map