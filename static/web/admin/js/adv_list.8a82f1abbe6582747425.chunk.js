...
/***/ (function(module, exports, __webpack_require__) {
	...
	render:function render(type){return type=="1"?"桌面广告":"启动广告";}},
	{
	title:'广告图',
	dataIndex:"img",
	className:"column-width-15",
	...
	className:"column-width-10",
	dataIndex:'status',
	render:function render(status){return status=="0"?"不显示":"显示";}},
	{
	title:"操作",
	className:"column-width-20",
	render:function render(data){return _react2.default.createElement('div',{style:{"textAlign":"center"}},
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:_this.goToAdvEdit.bind(_this,data.key),style:{"marginRight":"20px"}},'\u4FEE\u6539'),
	
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteAdv.bind(_this,data.key),
	...
	}},{key:'addAdv',value:function addAdv()
	
	{
	_reactRouter.hashHistory.push("/adv/add");
	}},{key:'goToAdvEdit',value:function goToAdvEdit(
	
	id){
	_reactRouter.hashHistory.push("/adv/edit/"+id);
	}},{key:'deleteAdv',value:function deleteAdv(
	...
	_react2.default.createElement(_antd.Button,{icon:'plus',onClick:this.addAdv,style:{"marginBottom":"20px"}},'\u6DFB\u52A0\u5E7F\u544A'),
...
//# sourceMappingURL=adv_list.8a82f1abbe6582747425.chunk.js.map