...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _loginForm=__webpack_require__(1523);var _loginForm2=_interopRequireDefault(_loginForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
	
	Login=exports.Login=function(_React$Component){(0,_inherits3.default)(Login,_React$Component);
	...
	props));
	}(0,_createClass3.default)(Login,[{key:'render',value:function render()
	
	{
	return(
	_react2.default.createElement('div',{className:'loginPage'},
	_react2.default.createElement(_antd.Row,{style:{height:"100%"},type:'flex',justify:'center',align:'middle'},
	_react2.default.createElement(_antd.Col,{style:{height:"300px"},span:12},
	_react2.default.createElement('div',{className:'title'},'\u6B22\u8FCE\u4F7F\u7528\u878D\u8001\u677F\u540E\u53F0\u7BA1\u7406\u7CFB\u7EDF'),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	LoginForm=function(_React$Component){(0,_inherits3.default)(LoginForm,_React$Component);
	...
	}(0,_createClass3.default)(LoginForm,[{key:'handleSubmit',value:function handleSubmit(
	e){var _this2=this;
	var that=this;
	e.preventDefault();
	...
	return(
	_react2.default.createElement(_antd.Form,{className:'login-form'},
	...
	_react2.default.createElement(FormItem,null,
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:this.handleSubmit,className:'login-form-button',style:{width:"100%"},disabled:this.state.buttonDisabled},'Log in'))));
	
	
	
	
	
	}}]);return LoginForm;}(_react2.default.Component);
...
//# sourceMappingURL=login.fa9bb57d45769eb510c7.chunk.js.map