...
/***/ (function(module, exports, __webpack_require__) {
	...
	['handleSubmit'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(DetailForm,[{key:'componentWillMount',value:function componentWillMount()
	...
	that.setState((0,_extends3.default)({loading:false},data));
	}});
	...
	method:"post",
	data:(0,_extends3.default)({id:that.props.userID},values),
	callback:function callback(data){
	...
	_react2.default.createElement(_antd.Form,{className:'userDetailForm'},
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u59D3\u540D'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.name)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u6027\u522B'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.gender==0?"男":"女")),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u6635\u79F0'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.nickName)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u5934\u50CF'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},
	...
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.region)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u516C\u53F8'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.company)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u90E8\u95E8'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.department)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u804C\u4F4D'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.position)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u624B\u673A'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.mobile)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u56FA\u5B9A\u7535\u8BDD'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.phone)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u90AE\u7BB1'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.mail)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'QQ'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.qq)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u5FAE\u4FE1'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.wx)),
	
	_react2.default.createElement(FormItem,(0,_extends3.default)({},
	formItemLayout,{
	label:'\u65B0\u6D6A\u5FAE\u535A'}),
	
	_react2.default.createElement('span',{className:'ant-form-text'},this.state.weibo)),
	...
	_react2.default.createElement(_antd.Radio,{value:'3'},'\u4E0D\u901A\u8FC7'),
	_react2.default.createElement(_antd.Radio,{value:'1'},'\u901A\u8FC7')))),
	
	
	
	_react2.default.createElement(FormItem,{wrapperCol:{span:8,offset:3}},
	_react2.default.createElement(_antd.Button,{className:this.props.type=="detail"?"hide":"btn-show",icon:'check',type:'primary',onClick:this.handleSubmit,style:{"marginRight":"20px"}},'\u5BA1\u6838'),
	_react2.default.createElement(_antd.Button,{icon:'rollback',onClick:this.return},'\u8FD4\u56DE')))));
	
	
	
	
	}}]);return DetailForm;}(_react2.default.Component);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dataForm=__webpack_require__(1391);var _dataForm2=_interopRequireDefault(_dataForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var Content=_antd.Layout.Content;var
	...
	_react2.default.createElement(_dataForm2.default,{type:'audit',userID:this.props.params.id}))));
...
//# sourceMappingURL=user_manage_audit.4f198d62160d43adfaf9.chunk.js.map