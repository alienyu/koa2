...
/***/ (function(module, exports, __webpack_require__) {
	...
	{
	_reactRouter.hashHistory.push("/platform/news/add");
	}},{key:'goToDetail',value:function goToDetail(
	
	id){
	_reactRouter.hashHistory.push("/platform/news/detail/"+id);
	}},{key:'goToEdit',value:function goToEdit(
	
	id){
	_reactRouter.hashHistory.push("/platform/news/edit/"+id);
	}},{key:'deleteInfo',value:function deleteInfo(
	
	id){
	var that=this;
	adminAjax({
	url:"/platform/news/deleteInfo",
	method:"post",
	data:{id:id},
	callback:function callback(data){
	...
	_react2.default.createElement(_antd.Button,{icon:'plus',onClick:this.goToAdd,style:{"marginBottom":"20px"}},'\u6DFB\u52A0\u884C\u4E1A\u52A8\u6001'),
...
//# sourceMappingURL=news_list.5149182edff60f0a8006.chunk.js.map