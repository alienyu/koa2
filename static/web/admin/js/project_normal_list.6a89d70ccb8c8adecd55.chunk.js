...
/***/ (function(module, exports, __webpack_require__) {
	...
	{
	title:'审核状态',
	render:function render(info){return _react2.default.createElement('div',null,selectOpsConfig.auditStatusList[info.status]);}},
	{
	title:'进度',
	dataIndex:"schedule",
	render:function render(schedule){return schedule==1?"已结束":"进行中";}},
	{
	title:'用户类型',
	dataIndex:'accountType',
	render:function render(accountType){return _react2.default.createElement('div',null,selectOpsConfig.userTypeList[accountType]);}},
	{
	title:'发布人',
	render:function render(data){return(
	_react2.default.createElement('div',{className:'divClick',onClick:_this.goToUserDetail.bind(_this,data.userId)},data.fullName));}},
	{
	title:"发布时间",
	...
	_react2.default.createElement(_antd.Button,{onClick:_this.auditInfo.bind(_this,data),style:{"marginRight":"20px"}},'\u5BA1\u6838'),
	...
	['goToUserDetail','changePage','handleSearch','showLoading','hideLoading'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(List,[{key:'componentDidMount',value:function componentDidMount()
	...
	}},{key:'publisherDetail',value:function publisherDetail(
	...
	data){
	_reactRouter.hashHistory.push("/project/normal/detail/"+data.key+"?assetsType="+data.projectCategory);
	}},{key:'auditInfo',value:function auditInfo(
	
	data){
	_reactRouter.hashHistory.push("/project/normal/audit/"+data.key+"?assetsType="+data.projectCategory);
	...
	_react2.default.createElement(_antd.Table,(0,_defineProperty3.default)({
	rowKey:function rowKey(data){return data.project.key;},
	bordered:true,
	dataSource:this.state.dataSource,
	columns:this.state.columns,
	pagination:this.state.pagination,
	onChange:this.changePage},'rowKey',
	'id'))))));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_react2.default.createElement(_antd.Select,null,
	_react2.default.createElement(Option,{value:'0'},'\u6240\u6709'),
	_react2.default.createElement(Option,{value:'1'},'\u5F85\u5BA1\u6838'),
	_react2.default.createElement(Option,{value:'2'},'\u672A\u901A\u8FC7'),
	_react2.default.createElement(Option,{value:'3'},'\u5DF2\u901A\u8FC7')))),
	...
	_react2.default.createElement(_antd.Button,{icon:'reload',onClick:this.resetForm},'\u91CD\u7F6E'))));
...
//# sourceMappingURL=project_normal_list.6a89d70ccb8c8adecd55.chunk.js.map