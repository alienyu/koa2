...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _searchForm=__webpack_require__(1443);var _searchForm2=_interopRequireDefault(_searchForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var Content=_antd.Layout.Content;
	var selectOpsConfig={
	catogoryList:{
	1:"债权",
	2:"股权",
	...
	_react2.default.createElement('div',{className:'divClick',onClick:_this.showReceivedItems.bind(_this,data.id)},data.receivedItemsNum));}},
	{
	title:"操作",
	...
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteInfo.bind(_this,data.id),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	_react2.default.createElement(_antd.Button,{style:{"marginRight":"20px"},type:'danger'},'\u5220\u9664')),
	
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u8BBE\u7F6E?',onConfirm:_this.setProgress.bind(_this,{id:data.id,type:!data.progress}),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	...
	var that=this;
	adminAjax({
	url:"/delegateProject/setProgress",
	data:obj,
	callback:function callback(data){
	that.state.dataSource.filter(function(item){return item.id==obj.id;})[0].progress=obj.type==false?0:1;
	...
	data){
	_reactRouter.hashHistory.push("/delegateProject/detail/"+data.id+"?assetsType="+data.category);
	}},{key:'editInfo',value:function editInfo(
	
	data){
	_reactRouter.hashHistory.push("/delegateProject/edit/"+data.id+"?assetsType="+data.category);
	...
	var newDataSource=that.state.dataSource.filter(function(item){return item.id!=key;});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_react2.default.createElement('a',{rel:'noopener noreferrer',href:'#/delegateProject/new?assetsType=1'},'\u503A\u6743\u9879\u76EE')),
	
	_react2.default.createElement(_antd.Menu.Item,null,
	_react2.default.createElement('a',{rel:'noopener noreferrer',href:'#/delegateProject/new?assetsType=2'},'\u80A1\u6743\u9879\u76EE')),
	
	_react2.default.createElement(_antd.Menu.Item,null,
	_react2.default.createElement('a',{rel:'noopener noreferrer',href:'#/delegateProject/new?assetsType=4'},'\u8D44\u4EA7\u8F6C\u8BA9')));var
...
//# sourceMappingURL=delegateProject_list.209c0f7931f32450aa7e.chunk.js.map