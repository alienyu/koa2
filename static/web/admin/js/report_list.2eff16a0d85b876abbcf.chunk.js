...
/***/ (function(module, exports, __webpack_require__) {
	...
	title:"信息类别",
	dataIndex:"category",
	render:function render(category){return category=="1"?"项目":"资金";}},
	{
	title:"信息标题",
	dataIndex:"title"},
	{
	...
	_react2.default.createElement('div',{className:'divClick',onClick:_this.goToUserDetail.bind(_this,data.publisher.id)},data.publisher.name));}},
	{
	title:"发布人手机",
	render:function render(data){return data.publisher.mobile;}},
	{
	title:"被举报次数",
	render:function render(data){return(
	_react2.default.createElement('div',{className:'divClick',onClick:_this.showReportList.bind(_this,data)},data.number));}},
	{
	title:"已审核举报次数",
	dataIndex:"auditNum"},
	{
	...
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteReport.bind(_this,data.id),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	...
	['loadListData','changePage','deleteReport'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	...
	}},{key:'showReportList',value:function showReportList(
	
	data){
	_reactRouter.hashHistory.push('/report/detail/'+data.id+'?title='+data.title);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_react2.default.createElement(_antd.Button,{type:'default',onClick:_this.goToDetail.bind(_this,data.key),style:{"marginRight":"20px"}},'\u67E5\u770B'),
	
	_react2.default.createElement(_antd.Button,{type:'primary',onClick:_this.goToEdit.bind(_this,data.key),style:{"marginRight":"20px"}},'\u4FEE\u6539'),
	
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteInfo.bind(_this,data.key),
	...
	['changePage','deleteInfo'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(List,[{key:'componentWillMount',value:function componentWillMount()
	...
	}},{key:'goToAdd',value:function goToAdd()
	
	{
	_reactRouter.hashHistory.push("/platform/report/add");
	}},{key:'goToDetail',value:function goToDetail(
	...
	_react2.default.createElement(Content,{style:{background:'#fff',padding:24,margin:0,minHeight:280}},
	_react2.default.createElement(_antd.Button,{icon:'plus',onClick:this.goToAdd,style:{"marginBottom":"20px"}},'\u6DFB\u52A0\u5A92\u4F53\u62A5\u9053'),
	_react2.default.createElement(_antd.Table,{
	bordered:true,
	dataSource:this.state.dataSource,
	columns:this.state.columns,
...
//# sourceMappingURL=report_list.2eff16a0d85b876abbcf.chunk.js.map