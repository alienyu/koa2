...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Detail(props){(0,_classCallCheck3.default)(this,Detail);var _this=(0,_possibleConstructorReturn3.default)(this,(Detail.__proto__||(0,_getPrototypeOf2.default)(Detail)).call(this,
	props));
	_this.state={
	loading:true,
	title:"",
	...
	_react2.default.createElement('div',{className:'divClick',onClick:_this.goToUserDetail.bind(_this,data.reporter.id)},data.reporter.name));}},
	{
	title:"举报人手机",
	render:function render(data){return data.reporter.mobile;}},
	{
	title:"举报内容",
	dataIndex:"content"},
	{
	...
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u5220\u9664?',onConfirm:_this.deleteReportDetail.bind(_this,data.id),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	_react2.default.createElement(_antd.Button,{style:{marginLeft:20},type:'danger'},'\u5220\u9664'))));}},
	...
	render:function render(data){return(
	!data.auditStatus?
	_react2.default.createElement('div',null,_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u901A\u8FC7?',onConfirm:_this.audit.bind(_this,{id:data.id,type:1}),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	_react2.default.createElement(_antd.Button,{style:{marginLeft:20},type:'default'},'\u901A\u8FC7')),
	
	_react2.default.createElement(_antd.Popconfirm,{placement:'left',title:'\u662F\u5426\u786E\u8BA4\u4E0D\u901A\u8FC7?',onConfirm:_this.audit.bind(_this,{id:data.id,type:2}),okText:'\u786E\u8BA4',cancelText:'\u53D6\u6D88'},
	_react2.default.createElement(_antd.Button,{style:{marginLeft:20},type:'danger'},'\u4E0D\u901A\u8FC7'))):
	_react2.default.createElement('div',{style:{textAlign:'center'}},
	data.auditStatus==1?"已通过":"未通过"));}}],
	...
	['loadListData','changePage','deleteReportDetail','audit'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(Detail,[{key:'componentWillMount',value:function componentWillMount()
	
	{
	this.loadListData(1);
	}},{key:'goToUserDetail',value:function goToUserDetail(
	...
	}},{key:'deleteReportDetail',value:function deleteReportDetail(
	...
	var newDataSource=that.state.dataSource.filter(function(item){return item.id!=id;});
	that.setState({dataSource:newDataSource});
	}});
	
	}},{key:'loadListData',value:function loadListData(
	...
	{
	history.back();
	}},{key:'audit',value:function audit(
	...
	_react2.default.createElement(_antd.Button,{style:{marginBottom:30},icon:'rollback',onClick:this.return},'\u8FD4\u56DE'),
	_react2.default.createElement(_antd.Row,{style:{marginBottom:20}},'\u88AB\u4E3E\u62A5\u6807\u9898: ',this.state.title),
	...
	rowKey:function rowKey(data){return data.id;}})))));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(adminAjax, $) {'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.DataForm=undefined;var _extends2=__webpack_require__(246);var _extends3=_interopRequireDefault(_extends2);var _getPrototypeOf=__webpack_require__(286);var _getPrototypeOf2=_interopRequireDefault(_getPrototypeOf);var _classCallCheck2=__webpack_require__(291);var _classCallCheck3=_interopRequireDefault(_classCallCheck2);var _createClass2=__webpack_require__(292);var _createClass3=_interopRequireDefault(_createClass2);var _possibleConstructorReturn2=__webpack_require__(296);var _possibleConstructorReturn3=_interopRequireDefault(_possibleConstructorReturn2);var _inherits2=__webpack_require__(330);var _inherits3=_interopRequireDefault(_inherits2);var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);
	var _reactRouter=__webpack_require__(178);
	var _antd=__webpack_require__(338);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
	var FormItem=_antd.Form.Item;
	var RadioGroup=_antd.Radio.Group;var
	TextArea=_antd.Input.TextArea;var
	DataForm=exports.DataForm=function(_React$Component){(0,_inherits3.default)(DataForm,_React$Component);
	function DataForm(props){(0,_classCallCheck3.default)(this,DataForm);var _this=(0,_possibleConstructorReturn3.default)(this,(DataForm.__proto__||(0,_getPrototypeOf2.default)(DataForm)).call(this,
	props));
	_this.state={
	...
	}(0,_createClass3.default)(DataForm,[{key:'componentDidMount',value:function componentDidMount()
	...
	callback:function callback(data){var _data$detailInfo=
	data.detailInfo,title=_data$detailInfo.title,source=_data$detailInfo.source,content=_data$detailInfo.content;
	that.setState({
	loading:false,
	title:title,
	source:source,
	...
	values=(0,_extends3.default)(values,{id:_this2.props.id});
	}
	adminAjax({
	...
	}},{key:'returnList',value:function returnList()
	...
	!this.state.disabled?_react2.default.createElement(_antd.Button,{type:'primary',onClick:this.handleSubmit,style:{"marginRight":"20px"}},'\u63D0\u4EA4'):"",
	
	_react2.default.createElement(_antd.Button,{onClick:this.returnList,style:{"marginRight":"20px"}},'\u53D6\u6D88'),
	!this.state.disabled?_react2.default.createElement(_antd.Button,{type:'danger',onClick:this.resetForm},'\u91CD\u7F6E'):""))));
	
	
	
	
	}}]);return DataForm;}(_react2.default.Component);
	
	
	var WrappedDataForm=_antd.Form.create({})(DataForm);
	
	module.exports=WrappedDataForm;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1273), __webpack_require__(1274)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dataForm=__webpack_require__(1492);var _dataForm2=_interopRequireDefault(_dataForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
	Content=_antd.Layout.Content;var
...
//# sourceMappingURL=report_detail.89d1e1a74b9fb249835b.chunk.js.map