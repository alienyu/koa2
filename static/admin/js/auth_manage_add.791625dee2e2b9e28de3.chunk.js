...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dataForm=__webpack_require__(1379);var _dataForm2=_interopRequireDefault(_dataForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
...
/***/ (function(module, exports, __webpack_require__) {
	...
	['handleSubmit','checkPassword','resetForm'].forEach(function(m){return _this[m]=_this[m].bind(_this);});return _this;
	}(0,_createClass3.default)(DataForm,[{key:'componentWillMount',value:function componentWillMount()
	...
	values=(0,_extends3.default)(values,{id:_this2.props.userID});
	}
	adminAjax({
	...
	data:values,
	callback:function callback(data){
	_antd.message.success(that.props.type=="edit"?"修改管理员成功!":"添加管理员成功",1,function(){
	...
	rules:[
	{required:true,message:'请选择管理员类型!'}],
	
	initialValue:this.state.roleId.toString()})(
	
	_react2.default.createElement(_antd.Select,{placeholder:'\u8BF7\u9009\u62E9\u8D26\u6237\u7C7B\u578B'},
	_react2.default.createElement(Option,{value:'1'},'\u8D85\u7EA7\u7BA1\u7406\u5458'),
	_react2.default.createElement(Option,{value:'2'},'\u7528\u6237\u7BA1\u7406\u5458'),
	_react2.default.createElement(Option,{value:'3'},'\u9879\u76EE\u7BA1\u7406\u5458'),
	_react2.default.createElement(Option,{value:'4'},'\u8D44\u91D1\u7BA1\u7406\u5458'),
	_react2.default.createElement(Option,{value:'5'},'\u5176\u4ED6\u7BA1\u7406\u5458')))),
	...
	_react2.default.createElement(_antd.Radio,{value:'0'},'\u7981\u7528'),
	_react2.default.createElement(_antd.Radio,{value:'1'},'\u542F\u7528')))),
	...
	_react2.default.createElement(_antd.Button,{type:'primary',htmlType:'submit',onClick:this.handleSubmit,style:{"marginRight":"20px"}},'\u63D0\u4EA4'),
	_react2.default.createElement(_antd.Button,{onClick:this.returnList,style:{"marginRight":"20px"}},'\u53D6\u6D88'),
	_react2.default.createElement(_antd.Button,{type:'danger',onClick:this.resetForm},'\u91CD\u7F6E')))));
...
//# sourceMappingURL=auth_manage_add.791625dee2e2b9e28de3.chunk.js.map