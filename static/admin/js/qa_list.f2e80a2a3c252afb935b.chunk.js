...
/***/ (function(module, exports, __webpack_require__) {
	...
	{
	_reactRouter.hashHistory.push("/help/qa/add");
	}},{key:'goToDetail',value:function goToDetail(
	
	id){
	_reactRouter.hashHistory.push("/help/qa/detail/"+id);
	}},{key:'goToEdit',value:function goToEdit(
	
	id){
	_reactRouter.hashHistory.push("/help/qa/edit/"+id);
	}},{key:'deleteInfo',value:function deleteInfo(
	
	id){
	var that=this;
	adminAjax({
	url:"/help/qa/deleteInfo",
	method:"post",
	data:{id:id},
	callback:function callback(data){
	...
	_react2.default.createElement(_antd.Button,{icon:'plus',onClick:this.goToAdd,style:{"marginBottom":"20px"}},'\u6DFB\u52A0'),
...
//# sourceMappingURL=qa_list.f2e80a2a3c252afb935b.chunk.js.map