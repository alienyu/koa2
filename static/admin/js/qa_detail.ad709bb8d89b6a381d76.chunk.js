...
/***/ (function(module, exports, __webpack_require__) {
	...
	adminAjax({
	url:"/help/qa/getInfoDetail",
	data:{
	id:this.props.id},
	
	callback:function callback(data){var _data$detailInfo=
	data.detailInfo,title=_data$detailInfo.title,content=_data$detailInfo.content;
	that.setState({
	loading:false,
	title:title,
	content:content});
	...
	adminAjax({
	url:"/help/qa/updateInfo",
	data:values,
	callback:function callback(data){
	_antd.message.success("设置成功!",1,function(){
	_reactRouter.hashHistory.push("/help/qa");
	});
	}});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dataForm=__webpack_require__(1502);var _dataForm2=_interopRequireDefault(_dataForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var
...
//# sourceMappingURL=qa_detail.ad709bb8d89b6a381d76.chunk.js.map