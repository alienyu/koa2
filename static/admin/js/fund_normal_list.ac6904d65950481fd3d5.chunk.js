...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _searchForm=__webpack_require__(1403);var _searchForm2=_interopRequireDefault(_searchForm);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var Content=_antd.Layout.Content;
	var selectOpsConfig={
	catogoryList:{
	1:"债权",
	2:"股权",
	...
	{
	title:'审核状态',
	render:function render(data){return _react2.default.createElement('div',null,selectOpsConfig.auditStatusList[data.audit.status]);}},
	{
	title:'进度',
	dataIndex:'progress',
	render:function render(progress){return _react2.default.createElement('div',null,selectOpsConfig.progressList[progress]);}},
	{
	title:'用户类型',
	dataIndex:'userType',
	render:function render(userType){return _react2.default.createElement('div',null,selectOpsConfig.userTypeList[userType]);}},
	{
	title:'发布人',
	dataIndex:'publisher',
	render:function render(publisher){return(
	_react2.default.createElement('div',{className:'divClick',onClick:_this.goToUserDetail.bind(_this,publisher.id)},publisher.name));}},
	{
	title:"发布时间",
	...
	}(0,_createClass3.default)(List,[{key:'goToUserDetail',value:function goToUserDetail(
	...
	data){
	_reactRouter.hashHistory.push("/fund/normal/detail/"+data.key+"?assetsType="+data.category);
	}},{key:'auditInfo',value:function auditInfo(
	
	data){
	_reactRouter.hashHistory.push("/fund/normal/audit/"+data.key+"?assetsType="+data.category);
	}},{key:'deleteInfo',value:function deleteInfo(
	
	key){
	var that=this;
	adminAjax({
	url:"/fund/normal/deleteInfo",
	method:"post",
	data:{id:key},
	...
	rowKey:function rowKey(record){return record.key;}})))));
...
//# sourceMappingURL=fund_normal_list.ac6904d65950481fd3d5.chunk.js.map